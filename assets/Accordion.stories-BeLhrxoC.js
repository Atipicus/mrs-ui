import{r as M,a as q,j as e,R as v}from"./iframe-DQx8_g_V.js";import{A as E,a as k,b as G}from"./AccordionSummary-DKs7zRGe.js";import{g as P,b as U,c as B,a as W,s as L}from"./memoTheme-DN4SvyIR.js";import{T as o}from"./Typography-CZi8l96O.js";import{B as I}from"./Button-CLLjXZO8.js";import{M as c}from"./MaterialSymbol-CpJx0R1p.js";import{S as N}from"./Stack-BVuQ1I4R.js";import"./preload-helper-PPVm8Dsz.js";import"./useSlot-B_5D0USw.js";import"./resolveComponentProps-BFKdE3VA.js";import"./useForkRef-dCFEyD_R.js";import"./useControlled-B8CjVrLB.js";import"./Collapse-B-BY0weP.js";import"./useTheme-CwEaitdl.js";import"./utils-D5lapdOP.js";import"./ButtonBase-CkEqPcMX.js";import"./useEventCallback-DtAB4E7S.js";import"./isFocusVisible-B8k4qzLc.js";import"./index-BEu7OL-j.js";import"./Paper-BN8KY7Ge.js";import"./Typography-COUO01Vf.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./theme-helpers-CoFoCxtx.js";import"./Button-DXeX4qnz.js";import"./CircularProgress-DZoBasVL.js";import"./Box-CHcgeXiQ.js";import"./useThemeProps-BsrmR-wD.js";function z(i){return P("MuiAccordionActions",i)}U("MuiAccordionActions",["root","spacing"]);const F=i=>{const{classes:d,disableSpacing:s}=i;return W({root:["root",!s&&"spacing"]},z,d)},V=L("div",{name:"MuiAccordionActions",slot:"Root",overridesResolver:(i,d)=>{const{ownerState:s}=i;return[d.root,!s.disableSpacing&&d.spacing]}})({display:"flex",alignItems:"center",padding:8,justifyContent:"flex-end",variants:[{props:i=>!i.disableSpacing,style:{"& > :not(style) ~ :not(style)":{marginLeft:8}}}]}),Y=M.forwardRef(function(d,s){const t=q({props:d,name:"MuiAccordionActions"}),{className:p,disableSpacing:l=!1,..._}=t,D={...t,disableSpacing:l},C=F(D);return e.jsx(V,{className:B(C.root,p),ref:s,ownerState:D,..._})}),n=v.forwardRef(({children:i,defaultExpanded:d=!1,disabled:s=!1,disableGutters:t=!1,expanded:p,onChange:l,square:_=!1,sx:D,...C},R)=>e.jsx(E,{ref:R,defaultExpanded:d,disabled:s,disableGutters:t,expanded:p,onChange:l,square:_,sx:{...D},...C,children:i}));n.displayName="Accordion";n.__docgenInfo={description:`Accordion component
...
}`,...S.parameters?.docs?.source},description:{story:"Nested accordions",...S.parameters?.docs?.description}}};const fe=["Playground","BasicAccordion","ControlledAccordion","DefaultExpanded","DisabledAccordion","WithActions","NoGutters","SquareCorners","CustomExpandIcons","NoExpandIcon","ComplexContent","NestedAccordions"];export{h as BasicAccordion,T as ComplexContent,y as ControlledAccordion,f as CustomExpandIcons,u as DefaultExpanded,x as DisabledAccordion,S as NestedAccordions,b as NoExpandIcon,g as NoGutters,m as Playground,j as SquareCorners,A as WithActions,fe as __namedExportsOrder,je as default};
