import{r as M,u as q,j as e,R as v}from"./iframe-BpxNhWet.js";import{A as E,a as k,b as G}from"./AccordionSummary-nzzd-y7C.js";import{g as P,b as U,s as B,c as W,a as L}from"./memoTheme-RRFU8_yt.js";import{T as o}from"./Typography-CjyUkEHo.js";import{B as I}from"./Button-DtEPxT8y.js";import{M as c}from"./MaterialSymbol-Cl2vUDdq.js";import{S as N}from"./Stack-C8lW8KS3.js";import"./preload-helper-PPVm8Dsz.js";import"./useSlot-DZOfbP_c.js";import"./resolveComponentProps-BSmzc2Aq.js";import"./useForkRef-n-W_vIsh.js";import"./useControlled-7guYJBA6.js";import"./Collapse-DOt3Qhmu.js";import"./useTheme-Ck5p_qF3.js";import"./utils-eZC6H0Ue.js";import"./ButtonBase-y6gtY0yW.js";import"./useEventCallback-VkQVGqps.js";import"./isFocusVisible-B8k4qzLc.js";import"./index-CoQGAd21.js";import"./index-BXsPAqCn.js";import"./Paper-DXlO5YG9.js";import"./Typography-CmwbP09K.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./theme-helpers-CoFoCxtx.js";import"./Button-DOpsGfdD.js";import"./CircularProgress-DNNUL0s-.js";import"./Box-d_uTaY91.js";import"./styled-BXcSIMoY.js";import"./useThemeProps-Cx2tuFwT.js";function z(i){return P("MuiAccordionActions",i)}U("MuiAccordionActions",["root","spacing"]);const F=i=>{const{classes:d,disableSpacing:s}=i;return L({root:["root",!s&&"spacing"]},z,d)},V=B("div",{name:"MuiAccordionActions",slot:"Root",overridesResolver:(i,d)=>{const{ownerState:s}=i;return[d.root,!s.disableSpacing&&d.spacing]}})({display:"flex",alignItems:"center",padding:8,justifyContent:"flex-end",variants:[{props:i=>!i.disableSpacing,style:{"& > :not(style) ~ :not(style)":{marginLeft:8}}}]}),Y=M.forwardRef(function(d,s){const t=q({props:d,name:"MuiAccordionActions"}),{className:p,disableSpacing:l=!1,..._}=t,D={...t,disableSpacing:l},C=F(D);return e.jsx(V,{className:W(C.root,p),ref:s,ownerState:D,..._})}),n=v.forwardRef(({children:i,defaultExpanded:d=!1,disabled:s=!1,disableGutters:t=!1,expanded:p,onChange:l,square:_=!1,sx:D,...C},R)=>e.jsx(E,{ref:R,defaultExpanded:d,disabled:s,disableGutters:t,expanded:p,onChange:l,square:_,sx:{...D},...C,children:i}));n.displayName="Accordion";n.__docgenInfo={description:`Accordion component
...
}`,...S.parameters?.docs?.source},description:{story:"Nested accordions",...S.parameters?.docs?.description}}};const Te=["Playground","BasicAccordion","ControlledAccordion","DefaultExpanded","DisabledAccordion","WithActions","NoGutters","SquareCorners","CustomExpandIcons","NoExpandIcon","ComplexContent","NestedAccordions"];export{h as BasicAccordion,T as ComplexContent,y as ControlledAccordion,f as CustomExpandIcons,u as DefaultExpanded,x as DisabledAccordion,S as NestedAccordions,b as NoExpandIcon,g as NoGutters,m as Playground,j as SquareCorners,A as WithActions,Te as __namedExportsOrder,be as default};
