import{R as y,j as e}from"./iframe-CaJfxxeA.js";import{M as R}from"./MaterialSymbol-D8ChqBBP.js";import{u as j}from"./useTheme-BY3Nwc-v.js";import{I as W}from"./IconButton-CdFiAkt1.js";import{A as D}from"./Alert-B9Pbo7XG.js";import{S as o}from"./Stack-n7thE6k7.js";import{T as b}from"./Typography-DVqwCqe_.js";import{B as i}from"./Box-DRdjk_r0.js";import{B as q}from"./Button-BJKs2Jb4.js";import"./preload-helper-PPVm8Dsz.js";import"./createSimplePaletteValueFilter-B7jR09Rm.js";import"./ButtonBase-BHnwxTjD.js";import"./useForkRef-C3chRDOJ.js";import"./useEventCallback-BYdCS-Tq.js";import"./isFocusVisible-B8k4qzLc.js";import"./CircularProgress-B70wwna8.js";import"./useSlot-B_nPvQQX.js";import"./resolveComponentProps-DD7apTsv.js";import"./createSvgIcon-AcT3u2Lj.js";import"./Close-DVYKMB4f.js";import"./Paper-CI5osXNJ.js";import"./useThemeProps-DtNhxYaA.js";const F={error:"error",warning:"error",info:"info",success:"check_circle"};function M(r,a){return j().palette._components.alert[r][a]}const t=y.forwardRef(({severity:r="error",variant:a="filled",title:m,description:h,icon:f=!0,close:A=!1,onClose:B,action:x,sx:C,children:k,...T},S)=>{const n=j(),s=M(r,a),w=`${n.shape.md}px`,g=F[r],I=a==="filled"?1:0,N=f===!1?!1:y.isValidElement(f)?f:g&&e.jsx(R,{icon:g,fill:I,size:"small",color:s.foreground}),v=A&&e.jsx(W,{size:"small","aria-label":"close",onClick:B,sx:{color:s.foreground},children:e.jsx(R,{icon:"close",size:"small",color:s.foreground})}),V=x?v?e.jsxs(o,{direction:"row",spacing:1,alignItems:"center",children:[x,v]}):x:v||void 0;return e.jsx(D,{ref:S,severity:r,variant:"standard",icon:N,action:V,sx:{borderRadius:w,backgroundColor:s.background,color:s.foreground,alignItems:"flex-justify",py:1.5,px:2,...a==="outlined"&&{border:`1px solid ${s.border}`},"& .MuiAlert-icon":{color:s.foreground,padding:1,marginRight:n.spacing(1),mt:.25},"& .MuiAlert-message":{padding:1,width:"100%"},"& .MuiAlert-action":{padding:0,marginLeft:n.spacing(2),alignItems:"flex-justify"},...C},...T,children:e.jsxs(o,{spacing:.25,children:[m&&e.jsx(b,{variant:"body1",fontWeight:n.typography.fontWeightMedium,lineHeight:1.5,children:m}),h&&e.jsx(b,{variant:"body2",lineHeight:1.43,children:h}),k]})})});t.displayName="Alert";t.__docgenInfo={description:"",methods:[],displayName:"Alert",props:{severity:{required:!1,tsType:{name:"union",raw:"'error' | 'warning' | 'info' | 'success'",elements:[{name:"literal",value:"'error'"},{name:"literal",value:"'warning'"},{name:"literal",value:"'info'"},{name:"literal",value:"'success'"}]},description:`Alert severity. Controls colors and default icon.
