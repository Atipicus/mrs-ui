...
}`,...g.parameters?.docs?.source},description:{story:"Overflow handling",...g.parameters?.docs?.description}}};const j=["Basic","WithSpacing","WithBorder","ResponsiveWidth","FlexboxContainer","GridContainer","AsComponents","CenteredContent","WithShadow","ColorPalette","NestedBoxes","OverflowHandling"];export{c as AsComponents,r as Basic,t as CenteredContent,l as ColorPalette,i as FlexboxContainer,s as GridContainer,x as NestedBoxes,g as OverflowHandling,d as ResponsiveWidth,a as WithBorder,p as WithShadow,e as WithSpacing,j as __namedExportsOrder,k as default};
