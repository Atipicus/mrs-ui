...
}`,...s.parameters?.docs?.source},description:{story:"Chips support various colors in the `filled` variant.",...s.parameters?.docs?.description}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  render: () => <Stack spacing={2}>
      <Stack direction="row" spacing={2} flexWrap="wrap">
...
}`,...n.parameters?.docs?.source},description:{story:"Chips support various colors in the `outlined` variant.",...n.parameters?.docs?.description}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  render: () => <Stack spacing={2}>
      <Stack direction="row" spacing={2} flexWrap="wrap">
...
}`,...c.parameters?.docs?.source},description:{story:"A chip can be disabled, preventing user interaction.",...c.parameters?.docs?.description}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
...
}`,...d.parameters?.docs?.source},description:{story:"A chip can be clickable, which applies hover and focus effects.",...d.parameters?.docs?.description}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  render: () => <Stack spacing={2}>
      <Stack direction="row" spacing={2} flexWrap="wrap">
...
}`,...p.parameters?.docs?.source},description:{story:"A chip can display an `Avatar` element.",...p.parameters?.docs?.description}}};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  render: () => <Stack spacing={2}>
      <Stack direction="row" spacing={2} flexWrap="wrap">
...
}`,...b.parameters?.docs?.source},description:{story:"A chip can be deletable by providing an `onDelete` callback.",...b.parameters?.docs?.description}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: () => <Stack spacing={2}>
      <Stack direction="row" spacing={2} flexWrap="wrap">
...
}`,...m.parameters?.docs?.source},description:{story:"A chip can include both an `Avatar` and a delete icon.",...m.parameters?.docs?.description}}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  render: () => <Box sx={{
    p: 4
  }}>
      <Stack spacing={4}>
...
}`,...x.parameters?.docs?.source},description:{story:"A comprehensive showcase of all chip variants, sizes, colors, and states. This is useful for visual regression testing.",...x.parameters?.docs?.description}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  render: () => <Box sx={{
    p: 4
  }}>
      <Stack spacing={4}>
