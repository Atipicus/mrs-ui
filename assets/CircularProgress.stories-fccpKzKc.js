...
}`,...g.parameters?.docs?.source},description:{story:"Full showcase",...g.parameters?.docs?.description}}};const V=["Default","Small","Large","Secondary","Inherit","Determinate","DeterminateWithLabel","AllSizes","AllColors","WithLabels","RealWorldExamples","FullShowcase"];export{m as AllColors,u as AllSizes,o as Default,p as Determinate,d as DeterminateWithLabel,g as FullShowcase,l as Inherit,n as Large,x as RealWorldExamples,c as Secondary,t as Small,h as WithLabels,V as __namedExportsOrder,D as default};
