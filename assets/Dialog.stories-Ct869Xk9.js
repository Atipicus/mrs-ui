import{r as L,u as P,j as e,R as Y}from"./iframe-kf3iXV71.js";import{c as $,g as V,a as z,b as n,D as a}from"./DialogContent-DFIF4qB-.js";import{B as t}from"./Button-Fd8f1xlF.js";import{T as p}from"./TextField-BEu7da4V.js";import{S as K}from"./Stack-DhqtlL7c.js";import{g as G,b as H,s as O,c as M,a as I,r as J}from"./memoTheme-BP35QvXU.js";import{T as U}from"./Typography-D7OXx-WT.js";import"./preload-helper-PPVm8Dsz.js";import"./useTheme-CFqsrFsw.js";import"./useSlot-C-z3Iy6Z.js";import"./resolveComponentProps-D5kB94Mf.js";import"./useForkRef-C0ta-nvQ.js";import"./Paper-COiM6cBi.js";import"./Fade-9Cbz_KXF.js";import"./utils-dzFt9SRZ.js";import"./ButtonBase-BOIlzF5p.js";import"./useEventCallback-BQqBUAHb.js";import"./isFocusVisible-B8k4qzLc.js";import"./index-386WNPFQ.js";import"./index-D_jOKBbo.js";import"./getReactElementRef-DV4M4qD7.js";import"./Modal-CeXdSwVR.js";import"./ownerWindow-BN2rbQ_G.js";import"./ownerDocument-DW-IO8s5.js";import"./createChainedFunction-BO_9K8Jh.js";import"./Portal-CcvW9h-K.js";import"./Button-DiTCnp2j.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./CircularProgress-DvL592in.js";import"./TextField-Du0KbXdy.js";import"./Select-D5YOAwla.js";import"./formControlState-Dq1zat_P.js";import"./useFormControl-QeAqvYx3.js";import"./FormLabel-BqTeJ3gD.js";import"./isMuiElement-D9hBewuv.js";import"./Menu-Ci5icKPi.js";import"./useSlotProps-Di6abCmH.js";import"./isHostComponent-DVu5iVWx.js";import"./Grow-CyiJ7GLp.js";import"./mergeSlotProps-lF6UIOdB.js";import"./List-mm8W9Q0Y.js";import"./ListContext-D6HQifCE.js";import"./useControlled-p59U7WGC.js";import"./createSvgIcon-6EGfVyow.js";import"./FormHelperText-BToeU-TR.js";import"./Stack-CC2KHLct.js";import"./styled-CJLSm8Cd.js";import"./useThemeProps-BwaOU6CV.js";function Q(o){return G("MuiDialogContentText",o)}H("MuiDialogContentText",["root"]);const X=o=>{const{classes:i}=o,c=I({root:["root"]},Q,i);return{...i,...c}},Z=O(U,{shouldForwardProp:o=>J(o)||o==="classes",name:"MuiDialogContentText",slot:"Root",overridesResolver:(o,i)=>i.root})({}),l=L.forwardRef(function(i,d){const c=P({props:i,name:"MuiDialogContentText"}),{children:h,className:g,...u}=c,m=X(u);return e.jsx(Z,{component:"p",variant:"body1",color:"textSecondary",ref:d,ownerState:u,className:M(m.root,g),...c,classes:m})}),ee=o=>{const{classes:i}=o;return I({root:["root"]},V,i)},oe=O(U,{name:"MuiDialogTitle",slot:"Root",overridesResolver:(o,i)=>i.root})({padding:"16px 24px",flex:"0 0 auto"}),r=L.forwardRef(function(i,d){const c=P({props:i,name:"MuiDialogTitle"}),{className:h,id:g,...u}=c,m=c,R=ee(m),{titleId:_=g}=L.useContext($);return e.jsx(oe,{component:"h2",className:M(R.root,h),ownerState:m,ref:d,variant:"h6",id:g??_,...u})}),N=Y.forwardRef(({open:o,onClose:i,maxWidth:d="sm",fullWidth:c=!1,fullScreen:h=!1,scroll:g="paper",children:u,...m},R)=>e.jsx(z,{ref:R,open:o,onClose:i,maxWidth:d,fullWidth:c,fullScreen:h,scroll:g,...m,children:u}));N.displayName="Dialog";N.__docgenInfo={description:"",methods:[],displayName:"Dialog",props:{open:{required:!0,tsType:{name:"boolean"},description:"If true, the dialog is open"},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: object, reason: 'backdropClick' | 'escapeKeyDown') => void",signature:{arguments:[{type:{name:"object"},name:"event"},{type:{name:"union",raw:"'backdropClick' | 'escapeKeyDown'",elements:[{name:"literal",value:"'backdropClick'"},{name:"literal",value:"'escapeKeyDown'"}]},name:"reason"}],return:{name:"void"}}},description:"Callback fired when the dialog requests to be closed"},maxWidth:{required:!1,tsType:{name:"union",raw:"'xs' | 'sm' | 'md' | 'lg' | 'xl' | false",elements:[{name:"literal",value:"'xs'"},{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"},{name:"literal",value:"'xl'"},{name:"literal",value:"false"}]},description:`The maximum width of the dialog
