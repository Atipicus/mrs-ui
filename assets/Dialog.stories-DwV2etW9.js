import{r as L,u as P,j as e,R as Y}from"./iframe-BFhFDpEs.js";import{c as $,g as V,a as z,b as n,D as a}from"./DialogContent-D6go3_C3.js";import{B as t}from"./Button-RV-P9iTd.js";import{T as p}from"./TextField-CpJLglNU.js";import{S as K}from"./Stack-uPitmuSi.js";import{g as G,b as H,s as O,c as M,a as I,r as J}from"./memoTheme-_aLF6IQY.js";import{T as U}from"./Typography-CvcjzMEn.js";import"./preload-helper-PPVm8Dsz.js";import"./useTheme-DO1mN57X.js";import"./useSlot-CVuoaOwG.js";import"./resolveComponentProps-p8x1PAPW.js";import"./useForkRef-BUOQBrqT.js";import"./Paper-goefkhcW.js";import"./Modal-DKFMEg5F.js";import"./ownerWindow-BN2rbQ_G.js";import"./ownerDocument-DW-IO8s5.js";import"./useEventCallback-BfLbMVgp.js";import"./createChainedFunction-BO_9K8Jh.js";import"./Portal-DOqPw-bv.js";import"./index-pa3kUrIv.js";import"./index-DIf4fGtn.js";import"./getReactElementRef-EsqkqcWj.js";import"./utils-CWTjw1bZ.js";import"./ButtonBase-znckyonR.js";import"./isFocusVisible-B8k4qzLc.js";import"./Button-LNs289zD.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./CircularProgress-Cnf-gzkD.js";import"./TextField-C74hLsBm.js";import"./Select-BXAxzm-X.js";import"./formControlState-Dq1zat_P.js";import"./useFormControl-C_rl2-5M.js";import"./FormLabel-QVFp9Pcu.js";import"./isMuiElement-CaC9lWNg.js";import"./Menu-OS2M2Rs1.js";import"./useSlotProps-C3mTkDzu.js";import"./isHostComponent-DVu5iVWx.js";import"./Grow-ClJ9Ia3k.js";import"./mergeSlotProps-CEFa6tSL.js";import"./List-DjIy5QzU.js";import"./ListContext-B_kbCgpr.js";import"./useControlled-DYFOj8xd.js";import"./createSvgIcon-vY1aqQsj.js";import"./FormHelperText-9v7GYrWC.js";import"./Stack-TGBX7v6H.js";import"./styled-BCHDsqBD.js";import"./useThemeProps-DMhVsQGE.js";function Q(o){return G("MuiDialogContentText",o)}H("MuiDialogContentText",["root"]);const X=o=>{const{classes:i}=o,c=I({root:["root"]},Q,i);return{...i,...c}},Z=O(U,{shouldForwardProp:o=>J(o)||o==="classes",name:"MuiDialogContentText",slot:"Root",overridesResolver:(o,i)=>i.root})({}),l=L.forwardRef(function(i,d){const c=P({props:i,name:"MuiDialogContentText"}),{children:h,className:g,...u}=c,m=X(u);return e.jsx(Z,{component:"p",variant:"body1",color:"textSecondary",ref:d,ownerState:u,className:M(m.root,g),...c,classes:m})}),ee=o=>{const{classes:i}=o;return I({root:["root"]},V,i)},oe=O(U,{name:"MuiDialogTitle",slot:"Root",overridesResolver:(o,i)=>i.root})({padding:"16px 24px",flex:"0 0 auto"}),r=L.forwardRef(function(i,d){const c=P({props:i,name:"MuiDialogTitle"}),{className:h,id:g,...u}=c,m=c,R=ee(m),{titleId:_=g}=L.useContext($);return e.jsx(oe,{component:"h2",className:M(R.root,h),ownerState:m,ref:d,variant:"h6",id:g??_,...u})}),N=Y.forwardRef(({open:o,onClose:i,maxWidth:d="sm",fullWidth:c=!1,fullScreen:h=!1,scroll:g="paper",children:u,...m},R)=>e.jsx(z,{ref:R,open:o,onClose:i,maxWidth:d,fullWidth:c,fullScreen:h,scroll:g,...m,children:u}));N.displayName="Dialog";N.__docgenInfo={description:"",methods:[],displayName:"Dialog",props:{open:{required:!0,tsType:{name:"boolean"},description:"If true, the dialog is open"},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: object, reason: 'backdropClick' | 'escapeKeyDown') => void",signature:{arguments:[{type:{name:"object"},name:"event"},{type:{name:"union",raw:"'backdropClick' | 'escapeKeyDown'",elements:[{name:"literal",value:"'backdropClick'"},{name:"literal",value:"'escapeKeyDown'"}]},name:"reason"}],return:{name:"void"}}},description:"Callback fired when the dialog requests to be closed"},maxWidth:{required:!1,tsType:{name:"union",raw:"'xs' | 'sm' | 'md' | 'lg' | 'xl' | false",elements:[{name:"literal",value:"'xs'"},{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"},{name:"literal",value:"'xl'"},{name:"literal",value:"false"}]},description:`The maximum width of the dialog
