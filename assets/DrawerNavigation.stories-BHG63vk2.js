import{R as c,r as V,j as e}from"./iframe-Bf0p-10g.js";import{E as _,S as L,D as $}from"./Send-BHvoTdH4.js";import{u as U}from"./useTheme-BbnQPM-2.js";import{B as r}from"./Box-Dt15EP8F.js";import{L as J}from"./List-CE1qvQVt.js";import{D as M}from"./Divider-QP05fqPZ.js";import{L as K}from"./ListItemButton-0EowQ0oD.js";import{L as Q}from"./ListItemIcon-CB6tLFN0.js";import{L as X}from"./ListItemText-TQZkK7wL.js";import{D as P}from"./Drawer-AJ-2pmma.js";import{H as m}from"./Home-Dl2fiwMa.js";import{I as d}from"./Inbox-Ivgp9qlF.js";import{S as p}from"./Settings-fA3T5pit.js";import{c as T}from"./createSvgIcon-Doqq-Dps.js";import{S as W}from"./ShoppingCart-BeaEczMt.js";import{B as N}from"./Button-ChPoXziC.js";import"./preload-helper-PPVm8Dsz.js";import"./createSimplePaletteValueFilter-CFqqyMQL.js";import"./utils-CtxyYRZu.js";import"./ButtonBase-CK-fqNHV.js";import"./useForkRef-mnbaXvWm.js";import"./useEventCallback-BOWsNkBB.js";import"./isFocusVisible-B8k4qzLc.js";import"./index-CoZST3LT.js";import"./index-2oKovSle.js";import"./ListContext-BkplqCot.js";import"./dividerClasses-UNPQwTGB.js";import"./listItemButtonClasses-hOHFse_1.js";import"./listItemIconClasses-BibaDTRy.js";import"./listItemTextClasses-vtqqJ3Sq.js";import"./useSlot-DCrjdO1I.js";import"./resolveComponentProps-CgVaspa1.js";import"./Typography-Dv1Rwxa5.js";import"./mergeSlotProps-DXlRdHCZ.js";import"./getReactElementRef-msSGuh9N.js";import"./ownerWindow-BN2rbQ_G.js";import"./ownerDocument-DW-IO8s5.js";import"./Modal-DqPLjk0H.js";import"./createChainedFunction-BO_9K8Jh.js";import"./Portal-i0MYpDyr.js";import"./Paper-moN_1IBd.js";import"./CircularProgress-C85rUP-r.js";function H(o){return o.expandable===!0}const a=c.forwardRef(({items:o,width:i=256,paddingTop:t=32,paddingBottom:n=32,sx:u,listSx:k,onItemClick:F},E)=>{const B=U(),[q,G]=V.useState(()=>{const s={};return o.forEach((l,x)=>{if(H(l)){const O=l.id||`item-${x}`;s[O]=l.defaultOpen||!1}}),s}),z=s=>{G(l=>({...l,[s]:!l[s]}))},R=s=>{s.onClick&&s.onClick(),F&&F(s)};return e.jsx(r,{ref:E,sx:{width:i,paddingTop:`${t}px`,paddingBottom:`${n}px`,fontFamily:B.typography.fontFamily,...u},children:e.jsx(J,{sx:{"& .MuiListItemButton-root":{fontFamily:B.typography.fontFamily},...k},children:o.map((s,l)=>{const x=s.id||`item-${l}`,O=l===o.length-1;if(H(s))return e.jsxs(c.Fragment,{children:[e.jsx(_,{label:s.label,icon:s.icon,isOpen:q[x],onToggle:()=>z(x),selected:s.selected,onClick:()=>R(s),children:s.children}),(s.divider||!O&&o[l+1]?.divider)&&e.jsx(M,{sx:{my:1}})]},x);const b=s;return e.jsxs(c.Fragment,{children:[e.jsxs(K,{selected:b.selected,onClick:()=>R(b),sx:{fontFamily:B.typography.fontFamily},children:[b.icon&&e.jsx(Q,{sx:{minWidth:40},children:b.icon}),e.jsx(X,{primary:b.label,primaryTypographyProps:{fontFamily:B.typography.fontFamily,fontWeight:b.selected?600:400}})]}),(b.divider||!O&&o[l+1]?.divider)&&e.jsx(M,{sx:{my:1}})]},x)})})})});a.displayName="DrawerNavigation";a.__docgenInfo={description:`DrawerNavigation component
