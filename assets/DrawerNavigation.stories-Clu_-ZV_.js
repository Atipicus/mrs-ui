import{R as d,r as W,j as e}from"./iframe-gZtTO8GF.js";import{E as _}from"./ExpandableNavItem-D-DYBjIW.js";import{u as E}from"./useTheme-CKQkYvCl.js";import{B as r}from"./Box-CkQ7KSea.js";import{L}from"./List-CxlzNAAf.js";import{D as N}from"./Divider-CHmZK9yF.js";import{L as q}from"./ListItemButton-DpZaBj-x.js";import{L as G}from"./ListItemIcon-CAWKq_Wz.js";import{L as H}from"./ListItemText-yqkfLopp.js";import{D as M}from"./Drawer-Bs3KNjRw.js";import{M as t}from"./MaterialSymbol-LwgaKelf.js";import{B}from"./Button-K1Jba8Wa.js";import"./preload-helper-PPVm8Dsz.js";import"./Collapse-DQh3hDQT.js";import"./memoTheme-DXIofXOq.js";import"./utils-Dk-_s8jP.js";import"./ButtonBase-CmgGEP9G.js";import"./useForkRef-B0PKJ5yw.js";import"./useEventCallback-BYIpU12S.js";import"./isFocusVisible-B8k4qzLc.js";import"./index-DzARVlfZ.js";import"./index-DK8gcBhr.js";import"./ListContext-CIsIg9XC.js";import"./dividerClasses-C6G62waq.js";import"./listItemButtonClasses-RPMygcif.js";import"./listItemIconClasses-CrafH7lZ.js";import"./listItemTextClasses-DXwzXPhd.js";import"./useSlot-B4JOn_ZD.js";import"./resolveComponentProps-BMSf_3UK.js";import"./Typography-BC_hpnXQ.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./mergeSlotProps-yX6Ong9U.js";import"./getReactElementRef-DP7AeASK.js";import"./ownerWindow-BN2rbQ_G.js";import"./ownerDocument-DW-IO8s5.js";import"./Modal-BsBwQ4ae.js";import"./createChainedFunction-BO_9K8Jh.js";import"./Portal-DoBnqfWT.js";import"./Paper-QqUT8uNK.js";import"./CircularProgress-CSM3WC29.js";function T(a){return a.expandable===!0}const n=d.forwardRef(({items:a,width:l=256,paddingTop:o=32,paddingBottom:i=32,sx:p,listSx:C,onItemClick:I},P)=>{const D=E(),[A,F]=W.useState(()=>{const s={};return a.forEach((c,b)=>{if(T(c)){const k=c.id||`item-${b}`;s[k]=c.defaultOpen||!1}}),s}),R=s=>{F(c=>({...c,[s]:!c[s]}))},O=s=>{s.onClick&&s.onClick(),I&&I(s)};return e.jsx(r,{ref:P,sx:{width:l,paddingTop:`${o}px`,paddingBottom:`${i}px`,fontFamily:D.typography.fontFamily,...p},children:e.jsx(L,{sx:{"& .MuiListItemButton-root":{fontFamily:D.typography.fontFamily},...C},children:a.map((s,c)=>{const b=s.id||`item-${c}`,k=c===a.length-1;if(T(s))return e.jsxs(d.Fragment,{children:[e.jsx(_,{label:s.label,icon:s.icon,isOpen:A[b],onToggle:()=>R(b),selected:s.selected,onClick:()=>O(s),children:s.children}),(s.divider||!k&&a[c+1]?.divider)&&e.jsx(N,{sx:{my:1}})]},b);const m=s;return e.jsxs(d.Fragment,{children:[e.jsxs(q,{selected:m.selected,onClick:()=>O(m),sx:{fontFamily:D.typography.fontFamily},children:[m.icon&&e.jsx(G,{sx:{minWidth:40},children:m.icon}),e.jsx(H,{primary:m.label,primaryTypographyProps:{fontFamily:D.typography.fontFamily,fontWeight:m.selected?600:400}})]}),(m.divider||!k&&a[c+1]?.divider)&&e.jsx(N,{sx:{my:1}})]},b)})})})});n.displayName="DrawerNavigation";n.__docgenInfo={description:`DrawerNavigation component
...
}`,...v.parameters?.docs?.source},description:{story:"Full application example",...v.parameters?.docs?.description}}};const Ne=["Default","WithExpandableItems","MixedItems","WithDividers","WithDrawer","PersistentDrawer","RightDrawer","CustomDimensions","WithoutIcons","FullApplication"];export{w as CustomDimensions,u as Default,v as FullApplication,h as MixedItems,y as PersistentDrawer,f as RightDrawer,g as WithDividers,S as WithDrawer,x as WithExpandableItems,j as WithoutIcons,Ne as __namedExportsOrder,Oe as default};
