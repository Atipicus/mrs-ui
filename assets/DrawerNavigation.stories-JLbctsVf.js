import{R as d,r as W,j as e}from"./iframe-guHiHJgM.js";import{E as _}from"./ExpandableNavItem-BW3XTIaJ.js";import{u as E}from"./useTheme-Me__gUwA.js";import{B as n}from"./Box-BbQdT_CQ.js";import{L}from"./List-DWz_G5xb.js";import{D as N}from"./Divider-B2D20Vf1.js";import{L as q}from"./ListItemButton-DeGOTX7Z.js";import{L as G}from"./ListItemIcon-bfW6hAVe.js";import{L as H}from"./ListItemText-Dv03nXc6.js";import{D as M}from"./Drawer-DzRKKnCi.js";import{M as t}from"./MaterialSymbol-BAO3yf_G.js";import{B}from"./Button-DpZeZ6aq.js";import"./preload-helper-PPVm8Dsz.js";import"./createSimplePaletteValueFilter-N-k1R-Q1.js";import"./utils-gSSSw1po.js";import"./ButtonBase-C6XQz7ud.js";import"./useForkRef-Uy7NJ8ru.js";import"./useEventCallback-DI0BNUn9.js";import"./isFocusVisible-B8k4qzLc.js";import"./index-CKgCG3EB.js";import"./index-BbDWFg6Z.js";import"./ListContext-DwmbI7UR.js";import"./dividerClasses-Csn5Io_5.js";import"./listItemButtonClasses-yj18y1vI.js";import"./listItemIconClasses-B6NiNqDW.js";import"./listItemTextClasses-CYOdnW28.js";import"./useSlot-BwZmQJDP.js";import"./resolveComponentProps-DAy9J68u.js";import"./Typography-Di50O9to.js";import"./mergeSlotProps-Bah95-Kr.js";import"./getReactElementRef-Ic5-yQ7W.js";import"./ownerWindow-BN2rbQ_G.js";import"./ownerDocument-DW-IO8s5.js";import"./Modal-BfUrpFbk.js";import"./createChainedFunction-BO_9K8Jh.js";import"./Portal-DTeqoHTY.js";import"./Paper-Bv-a0Gyk.js";import"./CircularProgress-BOENF8kS.js";function T(a){return a.expandable===!0}const r=d.forwardRef(({items:a,width:l=256,paddingTop:o=32,paddingBottom:i=32,sx:p,listSx:C,onItemClick:I},P)=>{const D=E(),[A,F]=W.useState(()=>{const s={};return a.forEach((c,b)=>{if(T(c)){const k=c.id||`item-${b}`;s[k]=c.defaultOpen||!1}}),s}),R=s=>{F(c=>({...c,[s]:!c[s]}))},O=s=>{s.onClick&&s.onClick(),I&&I(s)};return e.jsx(n,{ref:P,sx:{width:l,paddingTop:`${o}px`,paddingBottom:`${i}px`,fontFamily:D.typography.fontFamily,...p},children:e.jsx(L,{sx:{"& .MuiListItemButton-root":{fontFamily:D.typography.fontFamily},...C},children:a.map((s,c)=>{const b=s.id||`item-${c}`,k=c===a.length-1;if(T(s))return e.jsxs(d.Fragment,{children:[e.jsx(_,{label:s.label,icon:s.icon,isOpen:A[b],onToggle:()=>R(b),selected:s.selected,onClick:()=>O(s),children:s.children}),(s.divider||!k&&a[c+1]?.divider)&&e.jsx(N,{sx:{my:1}})]},b);const m=s;return e.jsxs(d.Fragment,{children:[e.jsxs(q,{selected:m.selected,onClick:()=>O(m),sx:{fontFamily:D.typography.fontFamily},children:[m.icon&&e.jsx(G,{sx:{minWidth:40},children:m.icon}),e.jsx(H,{primary:m.label,primaryTypographyProps:{fontFamily:D.typography.fontFamily,fontWeight:m.selected?600:400}})]}),(m.divider||!k&&a[c+1]?.divider)&&e.jsx(N,{sx:{my:1}})]},b)})})})});r.displayName="DrawerNavigation";r.__docgenInfo={description:`DrawerNavigation component
...
@returns DrawerNavigation component`,methods:[],displayName:"DrawerNavigation",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:"SimpleNavItem | ExpandableNavItem",elements:[{name:"SimpleNavItem"},{name:"ExpandableNavItem"}]}],raw:"DrawerNavItem[]"},description:"Array of navigation items"},width:{required:!1,tsType:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}]},description:"Width of the navigation (default: 256px from Figma)",defaultValue:{value:"256",computed:!1}},paddingTop:{required:!1,tsType:{name:"number"},description:"Top padding (default: 32px from Figma)",defaultValue:{value:"32",computed:!1}},paddingBottom:{required:!1,tsType:{name:"number"},description:"Bottom padding (default: 32px from Figma)",defaultValue:{value:"32",computed:!1}},sx:{required:!1,tsType:{name:"SxProps",elements:[{name:"Theme"}],raw:"SxProps<Theme>"},description:"Custom sx styles for the container"},listSx:{required:!1,tsType:{name:"SxProps",elements:[{name:"Theme"}],raw:"SxProps<Theme>"},description:"Custom sx styles for the List component"},onItemClick:{required:!1,tsType:{name:"signature",type:"function",raw:"(item: DrawerNavItemBase) => void",signature:{arguments:[{type:{name:"DrawerNavItemBase"},name:"item"}],return:{name:"void"}}},description:"Callback when a navigation item is clicked"}}};const Be={title:"Molecules/DrawerNavigation",component:r,tags:["autodocs"],argTypes:{width:{control:"number",description:"Width of the navigation (default: 256px)"},paddingTop:{control:"number",description:"Top padding (default: 32px)"},paddingBottom:{control:"number",description:"Bottom padding (default: 32px)"}}},u={render:()=>e.jsx(n,{sx:{width:256,bgcolor:"background.paper",height:400},children:e.jsx(r,{items:[{label:"Dashboard",icon:e.jsx(t,{icon:"home"}),selected:!0},{label:"Inbox",icon:e.jsx(t,{icon:"inbox"})},{label:"Settings",icon:e.jsx(t,{icon:"settings"})}]})})},x={render:()=>e.jsx(n,{sx:{width:256,bgcolor:"background.paper",height:500},children:e.jsx(r,{items:[{label:"Dashboard",icon:e.jsx(t,{icon:"home"}),selected:!0},{label:"Products",icon:e.jsx(t,{icon:"inbox"}),expandable:!0,defaultOpen:!0,children:[{label:"All Products",icon:e.jsx(t,{icon:"layers"})},{label:"Categories"},{label:"Tags"}]},{label:"Customers",icon:e.jsx(t,{icon:"people"})},{label:"Settings",icon:e.jsx(t,{icon:"settings"})}]})})},h={render:()=>e.jsx(n,{sx:{width:256,bgcolor:"background.paper",height:600},children:e.jsx(r,{items:[{label:"Dashboard",icon:e.jsx(t,{icon:"home"}),selected:!0},{label:"Mail",icon:e.jsx(t,{icon:"inbox"}),expandable:!0,children:[{label:"Inbox",icon:e.jsx(t,{icon:"inbox"})},{label:"Sent",icon:e.jsx(t,{icon:"send"})},{label:"Drafts",icon:e.jsx(t,{icon:"drafts"})}]},{label:"Analytics",icon:e.jsx(t,{icon:"bar_chart"})},{label:"E-commerce",icon:e.jsx(t,{icon:"shopping_cart"}),expandable:!0,children:[{label:"Products"},{label:"Orders"},{label:"Customers"}]},{label:"Settings",icon:e.jsx(t,{icon:"settings"})}]})})},g={render:()=>e.jsx(n,{sx:{width:256,bgcolor:"background.paper",height:400},children:e.jsx(r,{items:[{label:"Dashboard",icon:e.jsx(t,{icon:"home"}),divider:!0},{label:"Inbox",icon:e.jsx(t,{icon:"inbox"})},{label:"Customers",icon:e.jsx(t,{icon:"people"}),divider:!0},{label:"Settings",icon:e.jsx(t,{icon:"settings"})}]})})},S={render:()=>{const[a,l]=d.useState(!1),[o,i]=d.useState(0),p=[{id:"dashboard",label:"Dashboard",icon:e.jsx(t,{icon:"home"}),selected:o===0,onClick:()=>i(0)},{id:"products",label:"Products",icon:e.jsx(t,{icon:"inbox"}),expandable:!0,defaultOpen:!0,children:[{label:"All Products",selected:o===1,onClick:()=>i(1)},{label:"Categories",selected:o===2,onClick:()=>i(2)}]},{id:"customers",label:"Customers",icon:e.jsx(t,{icon:"people"}),selected:o===3,onClick:()=>i(3)},{id:"analytics",label:"Analytics",icon:e.jsx(t,{icon:"bar_chart"}),selected:o===4,onClick:()=>i(4)},{id:"settings",label:"Settings",icon:e.jsx(t,{icon:"settings"}),selected:o===5,onClick:()=>i(5)}];return e.jsxs(e.Fragment,{children:[e.jsx(B,{variant:"contained",onClick:()=>l(!0),children:"Open Drawer"}),e.jsx(M,{open:a,onClose:()=>l(!1),anchor:"left",children:e.jsx(r,{items:p})})]})}},y={render:()=>{const[a,l]=d.useState(!0),[o,i]=d.useState(0),p=[{id:"home",label:"Home",icon:e.jsx(t,{icon:"home"}),selected:o===0,onClick:()=>i(0)},{id:"mail",label:"Mail",icon:e.jsx(t,{icon:"inbox"}),expandable:!0,children:[{label:"Inbox",icon:e.jsx(t,{icon:"inbox"}),selected:o===1,onClick:()=>i(1)},{label:"Sent",icon:e.jsx(t,{icon:"send"}),selected:o===2,onClick:()=>i(2)}]},{id:"settings",label:"Settings",icon:e.jsx(t,{icon:"settings"}),selected:o===3,onClick:()=>i(3)}];return e.jsxs(n,{sx:{display:"flex"},children:[e.jsx(M,{variant:"persistent",open:a,anchor:"left",children:e.jsx(r,{items:p})}),e.jsxs(n,{sx:{flexGrow:1,p:3},children:[e.jsxs(B,{variant:"contained",onClick:()=>l(!a),children:[a?"Close":"Open"," Drawer"]}),e.jsxs(n,{sx:{mt:2},children:[e.jsx("h2",{children:"Main Content Area"}),e.jsxs("p",{children:["Selected item: ",o]})]})]})]})}},f={render:()=>{const[a,l]=d.useState(!1),o=[{label:"Profile",icon:e.jsx(t,{icon:"people"})},{label:"Settings",icon:e.jsx(t,{icon:"settings"})},{label:"Help",icon:e.jsx(t,{icon:"inbox"})}];return e.jsxs(e.Fragment,{children:[e.jsx(B,{variant:"contained",onClick:()=>l(!0),children:"Open Right Drawer"}),e.jsx(M,{open:a,onClose:()=>l(!1),anchor:"right",children:e.jsx(r,{items:o})})]})}},w={render:()=>e.jsx(n,{sx:{width:320,bgcolor:"background.paper",height:400},children:e.jsx(r,{width:320,paddingTop:16,paddingBottom:16,items:[{label:"Dashboard",icon:e.jsx(t,{icon:"home"})},{label:"Inbox",icon:e.jsx(t,{icon:"inbox"})},{label:"Settings",icon:e.jsx(t,{icon:"settings"})}]})})},j={render:()=>e.jsx(n,{sx:{width:256,bgcolor:"background.paper",height:400},children:e.jsx(r,{items:[{label:"Home",selected:!0},{label:"Documentation",expandable:!0,children:[{label:"Getting Started"},{label:"Components"},{label:"API Reference"}]},{label:"Support"}]})})},v={render:()=>{const[a,l]=d.useState(!0),[o,i]=d.useState("dashboard"),p=[{id:"dashboard",label:"Dashboard",icon:e.jsx(t,{icon:"home"}),selected:o==="dashboard",onClick:()=>i("dashboard"),divider:!0},{id:"products",label:"Products",icon:e.jsx(t,{icon:"shopping_cart"}),expandable:!0,defaultOpen:o.startsWith("products"),children:[{id:"products-all",label:"All Products",selected:o==="products-all",onClick:()=>i("products-all")},{id:"products-categories",label:"Categories",selected:o==="products-categories",onClick:()=>i("products-categories")},{id:"products-inventory",label:"Inventory",selected:o==="products-inventory",onClick:()=>i("products-inventory")}]},{id:"customers",label:"Customers",icon:e.jsx(t,{icon:"people"}),selected:o==="customers",onClick:()=>i("customers")},{id:"analytics",label:"Analytics",icon:e.jsx(t,{icon:"bar_chart"}),selected:o==="analytics",onClick:()=>i("analytics"),divider:!0},{id:"settings",label:"Settings",icon:e.jsx(t,{icon:"settings"}),selected:o==="settings",onClick:()=>i("settings")}];return e.jsxs(n,{sx:{display:"flex",height:"100vh"},children:[e.jsx(M,{variant:"persistent",open:a,anchor:"left",sx:{"& .MuiDrawer-paper":{position:"relative"}},children:e.jsx(r,{items:p})}),e.jsxs(n,{sx:{flexGrow:1,p:3,bgcolor:"#f5f5f5"},children:[e.jsxs(B,{variant:"outlined",onClick:()=>l(!a),sx:{mb:2},children:[a?"Close":"Open"," Navigation"]}),e.jsxs(n,{sx:{bgcolor:"white",p:3,borderRadius:1},children:[e.jsx("h1",{children:o.split("-").map(C=>C.charAt(0).toUpperCase()+C.slice(1)).join(" ")}),e.jsx("p",{children:"This is the content area for the selected navigation item."})]})]})]})}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  render: () => <Box sx={{
    width: 256,
...
}`,...v.parameters?.docs?.source},description:{story:"Full application example",...v.parameters?.docs?.description}}};const Ie=["Default","WithExpandableItems","MixedItems","WithDividers","WithDrawer","PersistentDrawer","RightDrawer","CustomDimensions","WithoutIcons","FullApplication"];export{w as CustomDimensions,u as Default,v as FullApplication,h as MixedItems,y as PersistentDrawer,f as RightDrawer,g as WithDividers,S as WithDrawer,x as WithExpandableItems,j as WithoutIcons,Ie as __namedExportsOrder,Be as default};
