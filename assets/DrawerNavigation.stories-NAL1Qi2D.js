import{R as d,r as W,j as e}from"./iframe-KbWxCWh5.js";import{E as _}from"./ExpandableNavItem-DAWeWBDS.js";import{u as E}from"./useTheme-JDDLTmum.js";import{B as r}from"./Box-CD9f05Kp.js";import{L}from"./List-DW1a55VE.js";import{D as N}from"./Divider-BcNDYCij.js";import{L as q}from"./ListItemButton-BsLTktfy.js";import{L as G}from"./ListItemIcon-BShjG7zz.js";import{L as H}from"./ListItemText-DIOyLd_D.js";import{D as M}from"./Drawer-CYatcaAf.js";import{M as t}from"./MaterialSymbol-CRf15fzs.js";import{B}from"./Button-B9dl-wUR.js";import"./preload-helper-PPVm8Dsz.js";import"./Collapse-C_6MwDAy.js";import"./memoTheme-CD-unLW0.js";import"./utils-CS5KkZ9f.js";import"./ButtonBase-BsRfRYMN.js";import"./useForkRef-DdHlOThs.js";import"./useEventCallback-CUjcavDR.js";import"./isFocusVisible-B8k4qzLc.js";import"./index-DSyiGWZB.js";import"./index-BHVZHAHP.js";import"./ListContext-D95NvwA2.js";import"./dividerClasses-xHC3EmUt.js";import"./listItemButtonClasses-IEJFTxct.js";import"./listItemIconClasses-CFli_WlW.js";import"./listItemTextClasses-BWkIlIso.js";import"./useSlot-DGoob9yj.js";import"./resolveComponentProps-DiXWND4P.js";import"./Typography-C621kO0v.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./mergeSlotProps-DJ5NIoUb.js";import"./Slide-BUkH5XY8.js";import"./getReactElementRef-Ck4Ylxfz.js";import"./ownerWindow-BN2rbQ_G.js";import"./ownerDocument-DW-IO8s5.js";import"./Modal-Bx97dbJ_.js";import"./createChainedFunction-BO_9K8Jh.js";import"./Portal-CKdP6XBt.js";import"./Fade-BwenHbs-.js";import"./Paper-YSH2Mx2W.js";import"./CircularProgress-BrtbgswC.js";function T(a){return a.expandable===!0}const n=d.forwardRef(({items:a,width:l=256,paddingTop:o=32,paddingBottom:i=32,sx:p,listSx:C,onItemClick:I},P)=>{const D=E(),[A,F]=W.useState(()=>{const s={};return a.forEach((c,b)=>{if(T(c)){const k=c.id||`item-${b}`;s[k]=c.defaultOpen||!1}}),s}),R=s=>{F(c=>({...c,[s]:!c[s]}))},O=s=>{s.onClick&&s.onClick(),I&&I(s)};return e.jsx(r,{ref:P,sx:{width:l,paddingTop:`${o}px`,paddingBottom:`${i}px`,fontFamily:D.typography.fontFamily,...p},children:e.jsx(L,{sx:{"& .MuiListItemButton-root":{fontFamily:D.typography.fontFamily},...C},children:a.map((s,c)=>{const b=s.id||`item-${c}`,k=c===a.length-1;if(T(s))return e.jsxs(d.Fragment,{children:[e.jsx(_,{label:s.label,icon:s.icon,isOpen:A[b],onToggle:()=>R(b),selected:s.selected,onClick:()=>O(s),children:s.children}),(s.divider||!k&&a[c+1]?.divider)&&e.jsx(N,{sx:{my:1}})]},b);const m=s;return e.jsxs(d.Fragment,{children:[e.jsxs(q,{selected:m.selected,onClick:()=>O(m),sx:{fontFamily:D.typography.fontFamily},children:[m.icon&&e.jsx(G,{sx:{minWidth:40},children:m.icon}),e.jsx(H,{primary:m.label,primaryTypographyProps:{fontFamily:D.typography.fontFamily,fontWeight:m.selected?600:400}})]}),(m.divider||!k&&a[c+1]?.divider)&&e.jsx(N,{sx:{my:1}})]},b)})})})});n.displayName="DrawerNavigation";n.__docgenInfo={description:`DrawerNavigation component
