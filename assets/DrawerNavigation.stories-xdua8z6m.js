import{R as d,r as W,j as e}from"./iframe-m0FcCUbT.js";import{E as _}from"./ExpandableNavItem-DrLs2uZI.js";import{u as E}from"./useTheme--qrtAMJV.js";import{B as r}from"./Box-DSq61m1Q.js";import{L}from"./List-Ba_CvKvH.js";import{D as N}from"./Divider-CdPfqsjd.js";import{L as q}from"./ListItemButton-BYI2t3oD.js";import{L as G}from"./ListItemIcon-Bff23pdV.js";import{L as H}from"./ListItemText-Dk1M7QNA.js";import{D as M}from"./Drawer-1mYB5ZPy.js";import{M as t}from"./MaterialSymbol-DOQyWWmo.js";import{B}from"./Button-CJ6MgozL.js";import"./preload-helper-PPVm8Dsz.js";import"./Collapse-CLX8PkYR.js";import"./memoTheme-C11nCEJ1.js";import"./utils-e4gBpPL7.js";import"./ButtonBase-Bd5szlVj.js";import"./useForkRef-DeUHlcp-.js";import"./useEventCallback-Cbn4Qfni.js";import"./isFocusVisible-TJLqzInv.js";import"./elementTypeAcceptingRef-Gtb8CsfE.js";import"./chainPropTypes-CPkqCYVL.js";import"./index-CMwIBjt_.js";import"./index-DWLUMx4m.js";import"./ListContext-CR7FhADn.js";import"./dividerClasses-BNo97-_l.js";import"./listItemButtonClasses-EFbDy94Y.js";import"./listItemIconClasses-CJee0vtT.js";import"./listItemTextClasses-BDtsEENN.js";import"./useSlot-BPbjla4P.js";import"./resolveComponentProps-hVTJcm9D.js";import"./Typography-BAhyjZNg.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./mergeSlotProps-Bkt73wcY.js";import"./Slide-C1l53flz.js";import"./getReactElementRef-DAzX-jKI.js";import"./ownerWindow-BN2rbQ_G.js";import"./ownerDocument-DW-IO8s5.js";import"./HTMLElementType-Bpqya3bH.js";import"./Modal-DCqzUJ55.js";import"./createChainedFunction-BO_9K8Jh.js";import"./Portal-BROk4iQM.js";import"./Fade-DvsUOEyO.js";import"./Paper-BQ8rpTFt.js";import"./integerPropType-DVPNO1YA.js";import"./CircularProgress-nywBWFjt.js";function T(a){return a.expandable===!0}const n=d.forwardRef(({items:a,width:l=256,paddingTop:o=32,paddingBottom:i=32,sx:p,listSx:C,onItemClick:I},P)=>{const D=E(),[A,F]=W.useState(()=>{const s={};return a.forEach((c,b)=>{if(T(c)){const k=c.id||`item-${b}`;s[k]=c.defaultOpen||!1}}),s}),R=s=>{F(c=>({...c,[s]:!c[s]}))},O=s=>{s.onClick&&s.onClick(),I&&I(s)};return e.jsx(r,{ref:P,sx:{width:l,paddingTop:`${o}px`,paddingBottom:`${i}px`,fontFamily:D.typography.fontFamily,...p},children:e.jsx(L,{sx:{"& .MuiListItemButton-root":{fontFamily:D.typography.fontFamily},...C},children:a.map((s,c)=>{const b=s.id||`item-${c}`,k=c===a.length-1;if(T(s))return e.jsxs(d.Fragment,{children:[e.jsx(_,{label:s.label,icon:s.icon,isOpen:A[b],onToggle:()=>R(b),selected:s.selected,onClick:()=>O(s),children:s.children}),(s.divider||!k&&a[c+1]?.divider)&&e.jsx(N,{sx:{my:1}})]},b);const m=s;return e.jsxs(d.Fragment,{children:[e.jsxs(q,{selected:m.selected,onClick:()=>O(m),sx:{fontFamily:D.typography.fontFamily},children:[m.icon&&e.jsx(G,{sx:{minWidth:40},children:m.icon}),e.jsx(H,{primary:m.label,primaryTypographyProps:{fontFamily:D.typography.fontFamily,fontWeight:m.selected?600:400}})]}),(m.divider||!k&&a[c+1]?.divider)&&e.jsx(N,{sx:{my:1}})]},b)})})})});n.displayName="DrawerNavigation";n.__docgenInfo={description:`DrawerNavigation component
...
}`,...v.parameters?.docs?.source},description:{story:"Full application example",...v.parameters?.docs?.description}}};const We=["Default","WithExpandableItems","MixedItems","WithDividers","WithDrawer","PersistentDrawer","RightDrawer","CustomDimensions","WithoutIcons","FullApplication"];export{w as CustomDimensions,u as Default,v as FullApplication,h as MixedItems,y as PersistentDrawer,f as RightDrawer,g as WithDividers,S as WithDrawer,x as WithExpandableItems,j as WithoutIcons,We as __namedExportsOrder,Re as default};
