...
}`,...T.parameters?.docs?.source},description:{story:"Basic grid",...T.parameters?.docs?.description}}};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  render: () => <Grid container spacing={2}>
...
}`,...b.parameters?.docs?.source},description:{story:"Responsive grid",...b.parameters?.docs?.description}}};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
...
}`,...N.parameters?.docs?.source},description:{story:"Responsive columns",...N.parameters?.docs?.description}}};const qr=["Basic","Responsive","AutoWidth","DifferentSpacing","RowColumnSpacing","NestedGrid","ComplexLayout","CardGrid","DashboardLayout","ResponsiveColumns"];export{C as AutoWidth,T as Basic,k as CardGrid,$ as ComplexLayout,M as DashboardLayout,w as DifferentSpacing,R as NestedGrid,b as Responsive,N as ResponsiveColumns,P as RowColumnSpacing,qr as __namedExportsOrder,Kr as default};
