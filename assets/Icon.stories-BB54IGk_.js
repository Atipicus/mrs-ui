import{R as I,j as e}from"./iframe-I_XFRsdA.js";import{M as f}from"./MaterialSymbol-Br8eVjxd.js";import{T as o}from"./Typography-CGFubZPW.js";import{B as n}from"./Box-BG99FGjS.js";import{S as a}from"./Stack-B0iuLo85.js";import"./preload-helper-PPVm8Dsz.js";import"./memoTheme-Bc7bjadk.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./styled-C3ib8DW_.js";import"./useThemeProps-B8ojE8Tn.js";function T(i){return!i.type||i.type==="svg"}function N(i){return i.type==="font"}const r=I.forwardRef((i,z)=>{const{size:j="medium"}=i,b=j==="inherit"?"inherit":j;if(T(i)){const{icon:M,sx:v,...S}=i;return e.jsx(M,{ref:z,fontSize:b,...S,sx:{color:"inherit",...v}})}if(N(i)){const{iconName:M,sx:v,...S}=i;return e.jsx(f,{ref:z,icon:M,size:j,sx:{color:"inherit",...v},...S})}return null});r.displayName="Icon";r.__docgenInfo={description:`Icon component
...
}`,...h.parameters?.docs?.source},description:{story:"Recommended: Use MaterialSymbol directly",...h.parameters?.docs?.description}}};const U=["Default","SmallFont","MediumFont","LargeFont","InheritFont","PrimaryColor","SecondaryColor","ErrorColor","SuccessColor","AllSizes","IconGallery","RecommendedUsage"];export{g as AllSizes,t as Default,y as ErrorColor,u as IconGallery,m as InheritFont,p as LargeFont,c as MediumFont,d as PrimaryColor,h as RecommendedUsage,l as SecondaryColor,s as SmallFont,x as SuccessColor,U as __namedExportsOrder,E as default};
