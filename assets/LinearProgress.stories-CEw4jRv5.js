...
}`,...u.parameters?.docs?.source},description:{story:"Buffer variant",...u.parameters?.docs?.description}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    variant: 'buffer',
    value: 50,
    valueBuffer: 75,
...
}`,...d.parameters?.docs?.source},description:{story:"Buffer with label",...d.parameters?.docs?.description}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  render: () => <Box sx={{
    p: 4
  }}>
      <Stack spacing={4}>
...
}`,...p.parameters?.docs?.source},description:{story:"All variants showcase",...p.parameters?.docs?.description}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: () => <Box sx={{
    p: 4
  }}>
      <Stack spacing={4}>
...
}`,...x.parameters?.docs?.source},description:{story:"Full showcase",...x.parameters?.docs?.description}}};const q=["Default","Secondary","Inherit","Determinate","DeterminateWithLabel","Buffer","BufferWithLabel","AllVariants","AllColors","WithLabels","RealWorldExamples","FullShowcase"];export{m as AllColors,p as AllVariants,u as Buffer,d as BufferWithLabel,i as Default,l as Determinate,c as DeterminateWithLabel,x as FullShowcase,o as Inherit,v as RealWorldExamples,n as Secondary,h as WithLabels,q as __namedExportsOrder,R as default};
