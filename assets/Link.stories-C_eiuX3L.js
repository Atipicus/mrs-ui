...
}`,...w.parameters?.docs?.source},description:{story:"Custom styled link",...w.parameters?.docs?.description}}};const ke=["Basic","Primary","Secondary","UnderlineVariants","AllColors","TypographyVariants","ExternalLink","InlineLink","WithOnClick","DisabledAppearance","AsButton","NavigationLinks","InList","Breadcrumbs","FooterLinks","CustomStyled"];export{y as AllColors,g as AsButton,p as Basic,C as Breadcrumbs,w as CustomStyled,L as DisabledAppearance,x as ExternalLink,S as FooterLinks,j as InList,k as InlineLink,b as NavigationLinks,u as Primary,h as Secondary,f as TypographyVariants,m as UnderlineVariants,v as WithOnClick,ke as __namedExportsOrder,xe as default};
