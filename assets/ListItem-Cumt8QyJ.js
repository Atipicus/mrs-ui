import{R as g,j as d,d as p}from"./iframe-D1RbjC5Q.js";import{L as q}from"./List-BMalAK0x.js";import{u as k}from"./useTheme-OtGzbA5G.js";import{L as T}from"./ListItem-DgJgHUbR.js";import{L as C}from"./ListItemButton-C1kodyTt.js";const L=g.forwardRef(({children:t,dense:u=!1,disablePadding:a=!1,subheader:s,component:o="ul",sx:i,...n},r)=>d.jsx(q,{ref:r,dense:u,disablePadding:a,subheader:s,component:o,sx:i,...n,children:t}));L.displayName="List";L.__docgenInfo={description:`List component
...
@default 'ul'`,defaultValue:{value:"'ul'",computed:!1}},sx:{required:!1,tsType:{name:"MuiListProps['sx']",raw:"MuiListProps['sx']"},description:"The system prop that allows defining system overrides as well as additional CSS styles."}},composes:["MuiListProps"]};const b=g.forwardRef(({children:t,button:u=!0,dense:a=!1,disableGutters:s=!1,divider:o=!1,disablePadding:i=!1,secondaryAction:n,alignItems:r="center",selected:c=!1,disabled:I=!1,autoFocus:R=!1,onClick:x,component:l,sx:m,...f},y)=>{const e=k(),h=e.palette.primary._states?.hover??p(e.palette.primary.main,.08),w=e.palette.primary._states?.focus??p(e.palette.primary.main,.12),v=e.palette.primary._states?.selected??p(e.palette.primary.main,.12);return u?d.jsx(T,{ref:y,dense:a,disableGutters:s,divider:o,disablePadding:i,secondaryAction:n,...l&&{component:l},sx:m,...f,children:d.jsx(C,{selected:c,disabled:I,autoFocus:R,onClick:x,alignItems:r,sx:{"&:hover":{backgroundColor:h},"&:active":{backgroundColor:v},"&.Mui-focusVisible":{outline:`3px solid ${w}`,outlineOffset:0,borderRadius:e.shape.sm},"&.Mui-selected":{backgroundColor:v,"&:hover":{backgroundColor:h}},...c&&{"& .MuiListItemText-primary":{fontFamily:e.typography.subtitle1.fontFamily,fontWeight:e.typography.subtitle1.fontWeight,color:e.palette.primary.dark}}},children:t})}):d.jsx(T,{ref:y,dense:a,disableGutters:s,divider:o,disablePadding:i,secondaryAction:n,alignItems:r,...l&&{component:l},sx:m,...f,children:t})});b.displayName="ListItem";b.__docgenInfo={description:`ListItem component
