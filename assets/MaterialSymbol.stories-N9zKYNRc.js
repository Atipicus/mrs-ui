...
}`,...d.parameters?.docs?.source},description:{story:"Weight variants from thin (100) to bold (700)",...d.parameters?.docs?.description}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
...
}`,...g.parameters?.docs?.source},description:{story:"Grade variants showing visual weight adjustment",...g.parameters?.docs?.description}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  render: () => <Paper sx={{
    p: 3
  }}>
      <Typography variant="h6" gutterBottom>
...
}`,...p.parameters?.docs?.source},description:{story:"Common Material Symbols icons showcase",...p.parameters?.docs?.description}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: () => <Paper sx={{
    p: 3
  }}>
      <Typography variant="h6" gutterBottom>
...
}`,...u.parameters?.docs?.source},description:{story:"Comparison with different configurations",...u.parameters?.docs?.description}}};const _=["Default","Playground","AllSizes","FillVariants","WeightVariants","GradeVariants","CommonIcons","MRSDefaultStyle","ColorVariants","ClickableIcons","AccessibilityExamples","ConfigurationComparison"];export{x as AccessibilityExamples,c as AllSizes,y as ClickableIcons,h as ColorVariants,p as CommonIcons,u as ConfigurationComparison,n as Default,l as FillVariants,g as GradeVariants,m as MRSDefaultStyle,s as Playground,d as WeightVariants,_ as __namedExportsOrder,C as default};
