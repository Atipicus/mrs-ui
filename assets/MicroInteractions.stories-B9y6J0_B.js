import{r as i,Q as z,S as P,U as N,X as O,j as e,E as H}from"./iframe-D1RbjC5Q.js";import{B as C}from"./Button-CoCHA0_R.js";import{s as D}from"./memoTheme-BHji7iGl.js";import{B as U}from"./Badge-MYMhgrgv.js";import{B as m}from"./Box-UhoF91Mg.js";import{P as g}from"./Paper-CCQRCbpX.js";import{T as a}from"./Typography-Bs4iIcdt.js";import{S as h}from"./Stack-DUvBP7K6.js";import{T as F}from"./TextField-W4TdLGOG.js";import{G as R}from"./Grid-DSMO_r7h.js";import{C as E,a as L}from"./CardContent-D0RTTTGA.js";import{I as V}from"./IconButton-BinjQqNu.js";import"./preload-helper-PPVm8Dsz.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./ButtonBase-DmB9mBru.js";import"./useForkRef-wzc4n1vL.js";import"./useEventCallback-DjgC1dUr.js";import"./isFocusVisible-B8k4qzLc.js";import"./CircularProgress-Bj4VSBjE.js";import"./usePreviousProps-D5q1aHvS.js";import"./useSlot-DjDoZLnG.js";import"./resolveComponentProps-Czqt_z--.js";import"./useTheme-OtGzbA5G.js";import"./styled-BOMv-r7W.js";import"./useThemeProps-BF4rPfby.js";import"./Select-DOa3E1F0.js";import"./formControlState-Dq1zat_P.js";import"./useFormControl-kS_mHU9i.js";import"./FormLabel-DAhjFEr3.js";import"./isMuiElement-CA8b0Wys.js";import"./Menu-CzmfTGBP.js";import"./useSlotProps-C8ynAXIf.js";import"./isHostComponent-DVu5iVWx.js";import"./ownerDocument-DW-IO8s5.js";import"./ownerWindow-BN2rbQ_G.js";import"./Grow-BS0DPdNG.js";import"./utils-DqID799T.js";import"./index-CAtPToJh.js";import"./index-D9IwCifK.js";import"./getReactElementRef-Cdjd4OMK.js";import"./mergeSlotProps-5St_cDG1.js";import"./Modal-BBQUqVWm.js";import"./createChainedFunction-BO_9K8Jh.js";import"./Portal-BxH6jGNz.js";import"./Fade-BQfqyN0w.js";import"./List-BMalAK0x.js";import"./ListContext-DYv0ihFA.js";import"./useControlled-Cg4VrXlU.js";import"./createSvgIcon-DCZ7gTS6.js";import"./FormHelperText-CHxRKaX8.js";const Q=()=>{const[t,n]=i.useState([]),r=i.useCallback(s=>{const c=s.currentTarget.getBoundingClientRect(),d=Math.max(c.width,c.height),p=s.clientX-c.left-d/2,G=s.clientY-c.top-d/2,k={x:p,y:G,size:d,id:Date.now()};n(A=>[...A,k]);const w=parseInt(z)*6;setTimeout(()=>{n(A=>A.filter(q=>q.id!==k.id))},w)},[]),o=i.useCallback(()=>{n([])},[]);return{ripples:t,createRipple:r,clearRipples:o}},X=(t={})=>{const{duration:n=1e3,scale:r=1.05,enabled:o=!0}=t,s=i.useRef(null);return i.useEffect(()=>{if(!o||!s.current)return;const l=s.current,c=[{transform:"scale(1)"},{transform:`scale(${r})`},{transform:"scale(1)"}],d=l.animate(c,{duration:n,iterations:1/0,easing:"ease-in-out"});return()=>{d.cancel()}},[n,r,o]),s},_=(t={})=>{const{duration:n=parseInt(P),distance:r=10}=t,o=i.useRef(null),s=i.useCallback(()=>{if(!o.current)return;const l=o.current,c=[{transform:"translateX(0)"},{transform:`translateX(-${r}px)`},{transform:`translateX(${r}px)`},{transform:`translateX(-${r}px)`},{transform:`translateX(${r}px)`},{transform:"translateX(0)"}];l.animate(c,{duration:n,easing:"ease-in-out"})},[n,r]);return{ref:o,shake:s}},W=(t={})=>{const{duration:n=parseInt(N),scale:r=1.2}=t,o=i.useRef(null),s=i.useCallback(()=>{if(!o.current)return;const l=o.current,c=[{transform:"scale(1)"},{transform:`scale(${r})`},{transform:"scale(0.9)"},{transform:`scale(${r*.95})`},{transform:"scale(1)"}];l.animate(c,{duration:n,easing:"ease-out"})},[n,r]);return{ref:o,bounce:s}},M=(t={})=>{const{scale:n=1.05,duration:r=z,easing:o=O}=t,[s,l]=i.useState(!1),c=i.useCallback(()=>l(!0),[]),d=i.useCallback(()=>l(!1),[]),p={transform:s?`scale(${n})`:"scale(1)",transition:`transform ${r} ${o}`,cursor:"pointer"};return{isHovered:s,onMouseEnter:c,onMouseLeave:d,style:p}},Y=D("span")({position:"absolute",top:0,left:0,right:0,bottom:0,overflow:"hidden",pointerEvents:"none",borderRadius:"inherit"}),J=D("span")(({x:t,y:n,size:r})=>({position:"absolute",left:t,top:n,width:r,height:r,borderRadius:"50%",backgroundColor:"currentColor",opacity:.3,animation:`ripple ${parseInt(z)*6}ms ease-out`,"@keyframes ripple":{"0%":{transform:"scale(0)",opacity:.6},"100%":{transform:"scale(4)",opacity:0}}})),S=i.forwardRef(({children:t,disableRipple:n=!1,onClick:r,...o},s)=>{const{ripples:l,createRipple:c}=Q(),d=p=>{n||c(p),r?.(p)};return e.jsxs(C,{ref:s,onClick:d,sx:{position:"relative"},...o,children:[!n&&e.jsx(Y,{children:l.map(p=>e.jsx(J,{x:p.x,y:p.y,size:p.size},p.id))}),t]})});S.displayName="RippleButton";S.__docgenInfo={description:`RippleButton Component
...
@default false`,defaultValue:{value:"false",computed:!1}}},composes:["ButtonProps"]};const K=H`
  0%, 100% {
    transform: scale(1);
  }
  50% {
...
`,ee=D(U)(({animate:t,animationvariant:n})=>t?n==="bounce"?{"& .MuiBadge-badge":{animation:`${K} ${parseInt(P)*3}ms ease-in-out`}}:n==="pulse"?{"& .MuiBadge-badge":{animation:`${Z} 2s infinite`}}:{}:{}),$=({animationVariant:t="bounce",animateOnChange:n=!0,badgeContent:r,children:o,...s})=>{const[l,c]=i.useState(!1),[d,p]=i.useState(r);i.useEffect(()=>{if(!n||r===d)return;c(!0),p(r);const w=setTimeout(()=>{c(!1)},parseInt(P)*3);return()=>clearTimeout(w)},[r,d,n]);const k=t==="pulse"||l;return e.jsx(ee,{badgeContent:r,animate:k,animationvariant:t==="none"?void 0:t,...s,children:o})};$.__docgenInfo={description:`AnimatedBadge Component
...
}`,...T.parameters?.docs?.source},description:{story:"All Interactions Demo",...T.parameters?.docs?.description}}};const Ze=["RippleEffect","ShakeAnimation","BounceAnimation","HoverScale","PulseAnimation","AnimatedBadgeDemo","LoadingDotsDemo","AllInteractions"];export{T as AllInteractions,B as AnimatedBadgeDemo,f as BounceAnimation,v as HoverScale,j as LoadingDotsDemo,b as PulseAnimation,y as RippleEffect,x as ShakeAnimation,Ze as __namedExportsOrder,Ke as default};
