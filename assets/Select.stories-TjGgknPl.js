import{R as w,j as e,r as u}from"./iframe-KbWxCWh5.js";import{S as L,I as i}from"./Select-_Pof29nA.js";import{M as t}from"./MenuItem-uavurI9f.js";import{F as s}from"./FormLabel-r4Awn6VH.js";import{F}from"./FormHelperText-DsGR-FWc.js";import{B as A}from"./Box-CD9f05Kp.js";import{C as V}from"./Chip-CAH7Y1GK.js";import"./preload-helper-PPVm8Dsz.js";import"./memoTheme-CD-unLW0.js";import"./formControlState-Dq1zat_P.js";import"./useFormControl-Bv0b7xXl.js";import"./Menu-BWybUsqV.js";import"./useSlot-DGoob9yj.js";import"./resolveComponentProps-DiXWND4P.js";import"./useForkRef-DdHlOThs.js";import"./useSlotProps-DPf0Rt81.js";import"./isHostComponent-DVu5iVWx.js";import"./Paper-YSH2Mx2W.js";import"./useTheme-JDDLTmum.js";import"./ownerDocument-DW-IO8s5.js";import"./ownerWindow-BN2rbQ_G.js";import"./Grow-BlJsaBPa.js";import"./utils-CS5KkZ9f.js";import"./ButtonBase-BsRfRYMN.js";import"./useEventCallback-CUjcavDR.js";import"./isFocusVisible-B8k4qzLc.js";import"./index-DSyiGWZB.js";import"./index-BHVZHAHP.js";import"./getReactElementRef-Ck4Ylxfz.js";import"./mergeSlotProps-DJ5NIoUb.js";import"./Modal-Bx97dbJ_.js";import"./createChainedFunction-BO_9K8Jh.js";import"./Portal-CKdP6XBt.js";import"./Fade-BwenHbs-.js";import"./List-DW1a55VE.js";import"./ListContext-D95NvwA2.js";import"./useControlled-CJxix2li.js";import"./createSvgIcon-Bphyg1jv.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./MenuItem-CYch0a-9.js";import"./listItemIconClasses-CFli_WlW.js";import"./listItemTextClasses-BWkIlIso.js";import"./dividerClasses-xHC3EmUt.js";import"./isMuiElement-BG96RLnr.js";const o=w.forwardRef(({variant:n="outlined",color:r="primary",size:a="medium",fullWidth:p=!1,sx:O,...T},d)=>e.jsx(L,{ref:d,variant:n,color:r,size:a,fullWidth:p,sx:{fontFamily:l=>l.typography.fontFamily,borderRadius:l=>l.shape.lg,...n==="outlined"&&{"& .MuiOutlinedInput-root":{borderRadius:l=>l.shape.lg},"& .MuiOutlinedInput-notchedOutline":{borderColor:l=>l.palette._components?.input?.outlined?.enabledBorder||l.palette.divider},"&:hover .MuiOutlinedInput-notchedOutline":{borderColor:l=>l.palette.text.primary},"&.Mui-focused .MuiOutlinedInput-notchedOutline":{borderWidth:2}},...n==="filled"&&{backgroundColor:l=>l.palette._components?.input?.filled?.enabledFill||"rgba(0, 0, 0, 0.06)","&:hover":{backgroundColor:l=>l.palette._components?.input?.filled?.enabledFill||"rgba(0, 0, 0, 0.09)"},"&.Mui-focused":{backgroundColor:l=>l.palette._components?.input?.filled?.enabledFill||"rgba(0, 0, 0, 0.06)"}},...n==="standard"&&{"&:before":{borderBottomColor:l=>l.palette._components?.input?.standard?.enabledBorder||l.palette.divider},"&:hover:not(.Mui-disabled):before":{borderBottomColor:l=>l.palette.text.primary}},...O},...T}));o.displayName="Select";o.__docgenInfo={description:`Select component
...
@default false`},defaultValue:{required:!1,tsType:{name:"any"},description:"The default value. Use when the component is not controlled"},id:{required:!1,tsType:{name:"string"},description:"The id of the wrapper element"},name:{required:!1,tsType:{name:"string"},description:"Name attribute of the select element"},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: React.SyntheticEvent) => void",signature:{arguments:[{type:{name:"ReactSyntheticEvent",raw:"React.SyntheticEvent"},name:"event"}],return:{name:"void"}}},description:"Callback fired when the component requests to be closed"},onOpen:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: React.SyntheticEvent) => void",signature:{arguments:[{type:{name:"ReactSyntheticEvent",raw:"React.SyntheticEvent"},name:"event"}],return:{name:"void"}}},description:"Callback fired when the component requests to be opened"},open:{required:!1,tsType:{name:"boolean"},description:"If true, the menu is open"}},composes:["Omit"]};const ye={title:"Atoms/Select",component:o,tags:["autodocs"],argTypes:{variant:{control:"select",options:["outlined","filled","standard"],description:"The variant of the select"},color:{control:"select",options:["primary","secondary","error","warning","info","success"],description:"The color of the select"},size:{control:"select",options:["small","medium"],description:"The size of the select"},disabled:{control:"boolean",description:"If true, the select will be disabled"},error:{control:"boolean",description:"If true, the select will indicate an error"},fullWidth:{control:"boolean",description:"If true, the select will take up the full width"},multiple:{control:"boolean",description:"If true, allows multiple selections"}}},c={render:()=>{const[n,r]=u.useState("");return e.jsxs(o,{value:n,onChange:a=>r(a.target.value),displayEmpty:!0,children:[e.jsx(t,{value:"",children:e.jsx("em",{children:"None"})}),e.jsx(t,{value:10,children:"Ten"}),e.jsx(t,{value:20,children:"Twenty"}),e.jsx(t,{value:30,children:"Thirty"})]})}},m={render:()=>{const[n,r]=u.useState("");return e.jsxs(s,{fullWidth:!0,children:[e.jsx(i,{id:"age-label",children:"Age"}),e.jsxs(o,{labelId:"age-label",value:n,label:"Age",onChange:a=>r(a.target.value),children:[e.jsx(t,{value:10,children:"Ten"}),e.jsx(t,{value:20,children:"Twenty"}),e.jsx(t,{value:30,children:"Thirty"})]})]})}},v={render:()=>{const[n,r]=u.useState("");return e.jsxs(s,{fullWidth:!0,children:[e.jsx(i,{id:"age-helper-label",children:"Age"}),e.jsxs(o,{labelId:"age-helper-label",value:n,label:"Age",onChange:a=>r(a.target.value),children:[e.jsx(t,{value:10,children:"Ten"}),e.jsx(t,{value:20,children:"Twenty"}),e.jsx(t,{value:30,children:"Thirty"})]}),e.jsx(F,{children:"Please select your age range"})]})}},h={render:()=>{const[n,r]=u.useState("option1");return e.jsxs(s,{children:[e.jsx(i,{children:"Outlined"}),e.jsxs(o,{variant:"outlined",value:n,label:"Outlined",onChange:a=>r(a.target.value),children:[e.jsx(t,{value:"option1",children:"Option 1"}),e.jsx(t,{value:"option2",children:"Option 2"}),e.jsx(t,{value:"option3",children:"Option 3"})]})]})}},g={render:()=>{const[n,r]=u.useState("option1");return e.jsxs(s,{variant:"filled",children:[e.jsx(i,{children:"Filled"}),e.jsxs(o,{variant:"filled",value:n,label:"Filled",onChange:a=>r(a.target.value),children:[e.jsx(t,{value:"option1",children:"Option 1"}),e.jsx(t,{value:"option2",children:"Option 2"}),e.jsx(t,{value:"option3",children:"Option 3"})]})]})}},I={render:()=>{const[n,r]=u.useState("option1");return e.jsxs(s,{variant:"standard",children:[e.jsx(i,{children:"Standard"}),e.jsxs(o,{variant:"standard",value:n,label:"Standard",onChange:a=>r(a.target.value),children:[e.jsx(t,{value:"option1",children:"Option 1"}),e.jsx(t,{value:"option2",children:"Option 2"}),e.jsx(t,{value:"option3",children:"Option 3"})]})]})}},f={render:()=>{const[n,r]=u.useState("option1");return e.jsxs(s,{size:"small",children:[e.jsx(i,{children:"Small"}),e.jsxs(o,{size:"small",value:n,label:"Small",onChange:a=>r(a.target.value),children:[e.jsx(t,{value:"option1",children:"Option 1"}),e.jsx(t,{value:"option2",children:"Option 2"}),e.jsx(t,{value:"option3",children:"Option 3"})]})]})}},b={render:()=>{const[n,r]=u.useState("");return e.jsxs(s,{error:!0,fullWidth:!0,children:[e.jsx(i,{children:"Required Field"}),e.jsxs(o,{value:n,label:"Required Field",error:!0,onChange:a=>r(a.target.value),children:[e.jsx(t,{value:"option1",children:"Option 1"}),e.jsx(t,{value:"option2",children:"Option 2"})]}),e.jsx(F,{children:"This field is required"})]})}},x={render:()=>e.jsxs(s,{disabled:!0,children:[e.jsx(i,{children:"Disabled"}),e.jsxs(o,{value:"option1",label:"Disabled",disabled:!0,children:[e.jsx(t,{value:"option1",children:"Option 1"}),e.jsx(t,{value:"option2",children:"Option 2"})]})]})},S={render:()=>{const[n,r]=u.useState([]);return e.jsxs(s,{fullWidth:!0,children:[e.jsx(i,{children:"Multiple Select"}),e.jsxs(o,{multiple:!0,value:n,label:"Multiple Select",onChange:a=>r(a.target.value),children:[e.jsx(t,{value:"option1",children:"Option 1"}),e.jsx(t,{value:"option2",children:"Option 2"}),e.jsx(t,{value:"option3",children:"Option 3"}),e.jsx(t,{value:"option4",children:"Option 4"})]})]})}},M={render:()=>{const[n,r]=u.useState([]);return e.jsxs(s,{fullWidth:!0,children:[e.jsx(i,{children:"Select Tags"}),e.jsxs(o,{multiple:!0,value:n,label:"Select Tags",onChange:a=>r(a.target.value),renderValue:a=>e.jsx(A,{sx:{display:"flex",flexWrap:"wrap",gap:.5},children:a.map(p=>e.jsx(V,{label:p,size:"small"},p))}),children:[e.jsx(t,{value:"React",children:"React"}),e.jsx(t,{value:"TypeScript",children:"TypeScript"}),e.jsx(t,{value:"Material-UI",children:"Material-UI"}),e.jsx(t,{value:"Storybook",children:"Storybook"})]})]})}},y={render:()=>{const[n,r]=u.useState("option1");return e.jsxs(s,{children:[e.jsx(i,{children:"Auto Width"}),e.jsxs(o,{autoWidth:!0,value:n,label:"Auto Width",onChange:a=>r(a.target.value),children:[e.jsx(t,{value:"option1",children:"Short"}),e.jsx(t,{value:"option2",children:"Medium Length Option"}),e.jsx(t,{value:"option3",children:"Very Long Option Text Here"})]})]})}},j={render:()=>{const[n,r]=u.useState("option1"),[a,p]=u.useState("option1"),[O,T]=u.useState("option1");return e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"24px"},children:[e.jsxs(s,{children:[e.jsx(i,{children:"Outlined"}),e.jsxs(o,{variant:"outlined",value:n,label:"Outlined",onChange:d=>r(d.target.value),children:[e.jsx(t,{value:"option1",children:"Option 1"}),e.jsx(t,{value:"option2",children:"Option 2"})]})]}),e.jsxs(s,{variant:"filled",children:[e.jsx(i,{children:"Filled"}),e.jsxs(o,{variant:"filled",value:a,label:"Filled",onChange:d=>p(d.target.value),children:[e.jsx(t,{value:"option1",children:"Option 1"}),e.jsx(t,{value:"option2",children:"Option 2"})]})]}),e.jsxs(s,{variant:"standard",children:[e.jsx(i,{children:"Standard"}),e.jsxs(o,{variant:"standard",value:O,label:"Standard",onChange:d=>T(d.target.value),children:[e.jsx(t,{value:"option1",children:"Option 1"}),e.jsx(t,{value:"option2",children:"Option 2"})]})]})]})}},C={render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:["primary","secondary","error","warning","info","success"].map(n=>e.jsxs(s,{children:[e.jsx(i,{children:n.charAt(0).toUpperCase()+n.slice(1)}),e.jsxs(o,{color:n,value:"option1",label:n.charAt(0).toUpperCase()+n.slice(1),children:[e.jsx(t,{value:"option1",children:"Option 1"}),e.jsx(t,{value:"option2",children:"Option 2"})]})]},n))})};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  render: () => {
