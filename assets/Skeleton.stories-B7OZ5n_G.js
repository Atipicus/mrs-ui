import{R as T,j as a}from"./iframe-m0FcCUbT.js";import{S as b}from"./Skeleton-DMzl9i2y.js";import{B as e}from"./Box-DSq61m1Q.js";import{S as i}from"./Stack-DLDfFx0e.js";import{T as r}from"./Typography-BAhyjZNg.js";import{C as B,a as M}from"./CardContent-s39Wow6c.js";import"./preload-helper-PPVm8Dsz.js";import"./memoTheme-C11nCEJ1.js";import"./useThemeProps-OFH6wkZ1.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./Paper-BQ8rpTFt.js";import"./useTheme--qrtAMJV.js";import"./chainPropTypes-CPkqCYVL.js";import"./integerPropType-DVPNO1YA.js";const t=T.forwardRef(({variant:n="text",width:v,height:w,animation:S="pulse",...k},f)=>{let y=v,j=w;return n==="text"&&!v&&(y=120),n==="text"&&!w&&(j=12),n==="circular"&&!v&&!w&&(y=40,j=40),n==="rectangular"&&!v&&!w&&(y=120,j=120),a.jsx(b,{ref:f,variant:n,width:y,height:j,animation:S,...k})});t.displayName="Skeleton";t.__docgenInfo={description:`Skeleton component
...
}`,...u.parameters?.docs?.source},description:{story:"Different animations",...u.parameters?.docs?.description}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  render: () => <Box sx={{
    p: 4
  }}>
      <Stack spacing={4}>
...
}`,...m.parameters?.docs?.source},description:{story:"Real-world examples",...m.parameters?.docs?.description}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  render: () => <Box sx={{
    p: 4
  }}>
      <Stack spacing={6}>
...
}`,...g.parameters?.docs?.source},description:{story:"Full showcase",...g.parameters?.docs?.description}}};const H=["Default","Text","Circular","Rectangular","Rounded","WaveAnimation","NoAnimation","AllVariants","Animations","RealWorldExamples","FullShowcase"];export{p as AllVariants,u as Animations,c as Circular,s as Default,g as FullShowcase,x as NoAnimation,m as RealWorldExamples,d as Rectangular,h as Rounded,o as Text,l as WaveAnimation,H as __namedExportsOrder,F as default};
