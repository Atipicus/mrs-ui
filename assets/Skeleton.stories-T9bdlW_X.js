import{R as T,j as a}from"./iframe-BpxNhWet.js";import{S as b}from"./Skeleton-CO3sB7WU.js";import{B as e}from"./Box-d_uTaY91.js";import{S as i}from"./Stack-C8lW8KS3.js";import{T as r}from"./Typography-CmwbP09K.js";import{C as B,a as M}from"./CardContent-CQfg0E_V.js";import"./preload-helper-PPVm8Dsz.js";import"./memoTheme-RRFU8_yt.js";import"./styled-BXcSIMoY.js";import"./useThemeProps-Cx2tuFwT.js";import"./createSimplePaletteValueFilter-bm0fmN_7.js";import"./Paper-DXlO5YG9.js";import"./useTheme-Ck5p_qF3.js";const t=T.forwardRef(({variant:n="text",width:v,height:w,animation:S="pulse",...k},f)=>{let y=v,j=w;return n==="text"&&!v&&(y=120),n==="text"&&!w&&(j=12),n==="circular"&&!v&&!w&&(y=40,j=40),n==="rectangular"&&!v&&!w&&(y=120,j=120),a.jsx(b,{ref:f,variant:n,width:y,height:j,animation:S,...k})});t.displayName="Skeleton";t.__docgenInfo={description:`Skeleton component
...
}`,...g.parameters?.docs?.source},description:{story:"Full showcase",...g.parameters?.docs?.description}}};const F=["Default","Text","Circular","Rectangular","Rounded","WaveAnimation","NoAnimation","AllVariants","Animations","RealWorldExamples","FullShowcase"];export{p as AllVariants,u as Animations,c as Circular,s as Default,g as FullShowcase,x as NoAnimation,m as RealWorldExamples,d as Rectangular,h as Rounded,o as Text,l as WaveAnimation,F as __namedExportsOrder,_ as default};
