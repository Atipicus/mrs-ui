...
@param {number} index The thumb label's index to format.`},"aria-label":{required:!1,tsType:{name:"string"},description:"The label of the slider."},"aria-labelledby":{required:!1,tsType:{name:"string"},description:"The id of the element containing a label for the slider."},sx:{required:!1,tsType:{name:"MuiSliderProps['sx']",raw:"MuiSliderProps['sx']"},description:"The system prop that allows defining system overrides as well as additional CSS styles."}},composes:["Omit"]};const bt={title:"Atoms/Slider",component:d,tags:["autodocs"],argTypes:{size:{control:"select",options:["small","medium"],description:"The size of the slider."},color:{control:"select",options:["primary","secondary","error","info","success","warning"],description:"The color of the slider."},orientation:{control:"select",options:["horizontal","vertical"],description:"The component orientation."},disabled:{control:"boolean",description:"If `true`, the slider is disabled."},marks:{control:"boolean",description:"If `true`, marks are displayed."},step:{control:"number",description:"The granularity with which the slider can step through values."},min:{control:"number",description:"The minimum allowed value of the slider."},max:{control:"number",description:"The maximum allowed value of the slider."},valueLabelDisplay:{control:"select",options:["auto","on","off"],description:"Controls when the value label is displayed."},track:{control:"select",options:["normal","inverted",!1],description:"The track presentation."},sx:{control:"object",description:"The system prop that allows defining system overrides as well as additional CSS styles."}},parameters:{layout:"centered"}},Pe={args:{defaultValue:30},render:a=>e.jsx(i,{sx:{width:300},children:e.jsx(d,{...a})})},Ie={render:()=>e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"body2",gutterBottom:!0,children:"Continuous Slider"}),e.jsx(d,{defaultValue:30,"aria-label":"Default"})]}),parameters:{docs:{description:{story:"A continuous slider allows users to select a value along a subjective range."}}}},Ne={render:()=>e.jsxs(G,{spacing:3,sx:{width:300},children:[e.jsxs(i,{children:[e.jsx(l,{variant:"body2",gutterBottom:!0,children:"Small"}),e.jsx(d,{size:"small",defaultValue:30,"aria-label":"Small"})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"body2",gutterBottom:!0,children:"Medium (default)"}),e.jsx(d,{size:"medium",defaultValue:50,"aria-label":"Medium"})]})]})},He={render:()=>e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"body2",gutterBottom:!0,children:"Discrete slider with marks"}),e.jsx(d,{defaultValue:30,step:10,marks:!0,min:0,max:100,valueLabelDisplay:"auto","aria-label":"Discrete"})]}),parameters:{docs:{description:{story:"Discrete sliders can be adjusted to a specific value by referencing its value indicator."}}}},We={render:()=>{const a=[{value:0,label:"0°C"},{value:20,label:"20°C"},{value:37,label:"37°C"},{value:100,label:"100°C"}];return e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"body2",gutterBottom:!0,children:"Custom marks"}),e.jsx(d,{defaultValue:20,step:10,marks:a,valueLabelDisplay:"auto","aria-label":"Custom marks"})]})}},$e={render:()=>{const[a,t]=la.useState([20,40]),o=(s,h)=>{t(h)};return e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"body2",gutterBottom:!0,children:"Range Slider"}),e.jsx(d,{value:a,onChange:o,valueLabelDisplay:"auto","aria-label":"Range"})]})},parameters:{docs:{description:{story:"The slider can be used to set the start and end of a range by supplying an array of values."}}}},qe={render:()=>e.jsxs(G,{spacing:3,sx:{width:300},children:[e.jsxs(i,{children:[e.jsx(l,{variant:"body2",gutterBottom:!0,children:"Enabled"}),e.jsx(d,{defaultValue:30})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"body2",gutterBottom:!0,children:"Disabled"}),e.jsx(d,{defaultValue:30,disabled:!0})]})]})},Oe={render:()=>e.jsxs(G,{direction:"row",spacing:3,sx:{height:300},children:[e.jsxs(i,{children:[e.jsx(l,{variant:"body2",gutterBottom:!0,children:"Continuous"}),e.jsx(d,{orientation:"vertical",defaultValue:30,valueLabelDisplay:"auto","aria-label":"Vertical"})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"body2",gutterBottom:!0,children:"With marks"}),e.jsx(d,{orientation:"vertical",defaultValue:30,marks:!0,step:10,valueLabelDisplay:"auto","aria-label":"Vertical with marks"})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"body2",gutterBottom:!0,children:"Range"}),e.jsx(d,{orientation:"vertical",defaultValue:[20,40],valueLabelDisplay:"auto","aria-label":"Vertical range"})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"body2",gutterBottom:!0,children:"Disabled"}),e.jsx(d,{orientation:"vertical",defaultValue:30,disabled:!0,"aria-label":"Disabled vertical"})]})]}),parameters:{docs:{description:{story:'Set the orientation prop to "vertical" to create vertical sliders. The thumb will track vertical movement instead of horizontal movement.'}}}},Fe={render:()=>e.jsxs(i,{sx:{display:"flex",flexDirection:"column",gap:4,width:"100%",p:3},children:[e.jsx(l,{variant:"h6",children:"All Horizontal Slider Variants"}),e.jsxs(i,{children:[e.jsx(l,{variant:"body1",sx:{mb:2,fontWeight:"bold"},children:"Size: Medium"}),e.jsxs(G,{spacing:2,children:[e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"caption",children:"Continuous - Enabled"}),e.jsx(d,{size:"medium",defaultValue:30})]}),e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"caption",children:"Continuous - Disabled"}),e.jsx(d,{size:"medium",defaultValue:30,disabled:!0})]}),e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"caption",children:"With Marks - Enabled"}),e.jsx(d,{size:"medium",defaultValue:30,marks:!0,step:10})]}),e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"caption",children:"With Marks - Disabled"}),e.jsx(d,{size:"medium",defaultValue:30,marks:!0,step:10,disabled:!0})]}),e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"caption",children:"Range - Enabled"}),e.jsx(d,{size:"medium",defaultValue:[20,40]})]}),e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"caption",children:"Range - Disabled"}),e.jsx(d,{size:"medium",defaultValue:[20,40],disabled:!0})]})]})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"body1",sx:{mb:2,fontWeight:"bold"},children:"Size: Small"}),e.jsxs(G,{spacing:2,children:[e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"caption",children:"Continuous - Enabled"}),e.jsx(d,{size:"small",defaultValue:30})]}),e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"caption",children:"Continuous - Disabled"}),e.jsx(d,{size:"small",defaultValue:30,disabled:!0})]}),e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"caption",children:"With Marks - Enabled"}),e.jsx(d,{size:"small",defaultValue:30,marks:!0,step:10})]}),e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"caption",children:"With Marks - Disabled"}),e.jsx(d,{size:"small",defaultValue:30,marks:!0,step:10,disabled:!0})]}),e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"caption",children:"Range - Enabled"}),e.jsx(d,{size:"small",defaultValue:[20,40]})]}),e.jsxs(i,{sx:{width:300},children:[e.jsx(l,{variant:"caption",children:"Range - Disabled"}),e.jsx(d,{size:"small",defaultValue:[20,40],disabled:!0})]})]})]})]}),parameters:{docs:{description:{story:"Comprehensive view of all horizontal slider size and variant combinations with different states."}}}},Ue={render:()=>e.jsxs(i,{sx:{display:"flex",flexDirection:"column",gap:4,p:3},children:[e.jsx(l,{variant:"h6",children:"All Vertical Slider Variants"}),e.jsxs(i,{children:[e.jsx(l,{variant:"body1",sx:{mb:2,fontWeight:"bold"},children:"Size: Medium"}),e.jsxs(G,{direction:"row",spacing:3,sx:{height:300},children:[e.jsxs(i,{children:[e.jsx(l,{variant:"caption",children:"Continuous"}),e.jsx(d,{size:"medium",orientation:"vertical",defaultValue:30})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"caption",children:"Continuous (Disabled)"}),e.jsx(d,{size:"medium",orientation:"vertical",defaultValue:30,disabled:!0})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"caption",children:"With Marks"}),e.jsx(d,{size:"medium",orientation:"vertical",defaultValue:30,marks:!0,step:10})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"caption",children:"Marks (Disabled)"}),e.jsx(d,{size:"medium",orientation:"vertical",defaultValue:30,marks:!0,step:10,disabled:!0})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"caption",children:"Range"}),e.jsx(d,{size:"medium",orientation:"vertical",defaultValue:[20,40]})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"caption",children:"Range (Disabled)"}),e.jsx(d,{size:"medium",orientation:"vertical",defaultValue:[20,40],disabled:!0})]})]})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"body1",sx:{mb:2,fontWeight:"bold"},children:"Size: Small"}),e.jsxs(G,{direction:"row",spacing:3,sx:{height:300},children:[e.jsxs(i,{children:[e.jsx(l,{variant:"caption",children:"Continuous"}),e.jsx(d,{size:"small",orientation:"vertical",defaultValue:30})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"caption",children:"Continuous (Disabled)"}),e.jsx(d,{size:"small",orientation:"vertical",defaultValue:30,disabled:!0})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"caption",children:"With Marks"}),e.jsx(d,{size:"small",orientation:"vertical",defaultValue:30,marks:!0,step:10})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"caption",children:"Marks (Disabled)"}),e.jsx(d,{size:"small",orientation:"vertical",defaultValue:30,marks:!0,step:10,disabled:!0})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"caption",children:"Range"}),e.jsx(d,{size:"small",orientation:"vertical",defaultValue:[20,40]})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"caption",children:"Range (Disabled)"}),e.jsx(d,{size:"small",orientation:"vertical",defaultValue:[20,40],disabled:!0})]})]})]})]}),parameters:{docs:{description:{story:"Comprehensive view of all vertical slider size and variant combinations with different states."}}}},Ye={render:()=>{const[a,t]=la.useState(30),o=(s,h)=>{t(h)};return e.jsxs(i,{sx:{width:300},children:[e.jsxs(l,{variant:"body2",gutterBottom:!0,children:["Controlled Slider: ",a]}),e.jsx(d,{value:a,onChange:o,"aria-label":"Controlled"})]})},parameters:{docs:{description:{story:"Example of a controlled slider with React state."}}}},_e={render:()=>e.jsxs(G,{spacing:3,sx:{width:300},children:[e.jsxs(i,{children:[e.jsx(l,{variant:"body2",gutterBottom:!0,children:"Value label auto (on hover)"}),e.jsx(d,{defaultValue:30,valueLabelDisplay:"auto"})]}),e.jsxs(i,{children:[e.jsx(l,{variant:"body2",gutterBottom:!0,children:"Value label always on"}),e.jsx(d,{defaultValue:50,valueLabelDisplay:"on"})]})]})},Ke={args:{size:"medium",color:"primary",orientation:"horizontal",defaultValue:30,disabled:!1,marks:!1,step:1,min:0,max:100,valueLabelDisplay:"off",track:"normal"},render:a=>e.jsx(i,{sx:{width:a.orientation==="vertical"?"auto":300,height:a.orientation==="vertical"?300:"auto"},children:e.jsx(d,{...a})}),parameters:{docs:{description:{story:"Interactive playground to experiment with all Slider props."}}}};Pe.parameters={...Pe.parameters,docs:{...Pe.parameters?.docs,source:{originalSource:`{
  args: {
    defaultValue: 30
  },
  render: args => <Box sx={{
