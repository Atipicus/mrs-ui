...
}`,...L.parameters?.docs?.source},description:{story:"Error severity",...L.parameters?.docs?.description}}};P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
  render: () => <SnackbarDemo severity="warning">
      Your session will expire in 5 minutes
    </SnackbarDemo>
}`,...P.parameters?.docs?.source},description:{story:"Warning severity",...P.parameters?.docs?.description}}};D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  render: () => <SnackbarDemo severity="info">
      New updates are available
    </SnackbarDemo>
}`,...D.parameters?.docs?.source},description:{story:"Info severity",...D.parameters?.docs?.description}}};A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...N.parameters?.docs?.source},description:{story:"Consecutive Snackbars",...N.parameters?.docs?.description}}};const jt=["Default","SimpleMessage","Success","Error","Warning","Info","AlertVariants","Positions","NoCloseButton","CustomAction","Persistent","LongMessage","Consecutive"];export{A as AlertVariants,N as Consecutive,H as CustomAction,R as Default,L as Error,D as Info,I as LongMessage,M as NoCloseButton,F as Persistent,z as Positions,j as SimpleMessage,E as Success,P as Warning,jt as __namedExportsOrder,Rt as default};
