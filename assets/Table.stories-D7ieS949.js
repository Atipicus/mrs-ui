import{r as p,u as R,j as e,c as w,l as Te,f as ue,i as K,R as $}from"./iframe-guHiHJgM.js";import{M as ae}from"./MaterialSymbol-BAO3yf_G.js";import{g as v,b as S,s as j,c as k,a as B,m as J}from"./createSimplePaletteValueFilter-N-k1R-Q1.js";import{P as g}from"./Paper-Bv-a0Gyk.js";import{C as oe}from"./Checkbox-B-7_Mu0a.js";import{c as he}from"./createSvgIcon-C95dJPTr.js";import{u as ne}from"./useSlot-BwZmQJDP.js";import{B as Ce}from"./ButtonBase-C6XQz7ud.js";import{I as te}from"./IconButton-Cxax6mie.js";import"./preload-helper-PPVm8Dsz.js";import"./Box-BbQdT_CQ.js";import"./useTheme-Me__gUwA.js";import"./SwitchBase-DAie-rls.js";import"./useFormControl-B87usi3p.js";import"./useControlled-Bu7ShWSD.js";import"./mergeSlotProps-Bah95-Kr.js";import"./resolveComponentProps-DAy9J68u.js";import"./useForkRef-Uy7NJ8ru.js";import"./useEventCallback-DI0BNUn9.js";import"./isFocusVisible-B8k4qzLc.js";import"./CircularProgress-BOENF8kS.js";const pe=p.createContext();function xe(l){return v("MuiTable",l)}S("MuiTable",["root","stickyHeader"]);const ye=l=>{const{classes:a,stickyHeader:n}=l;return B({root:["root",n&&"stickyHeader"]},xe,a)},fe=j("table",{name:"MuiTable",slot:"Root",overridesResolver:(l,a)=>{const{ownerState:n}=l;return[a.root,n.stickyHeader&&a.stickyHeader]}})(J(({theme:l})=>({display:"table",width:"100%",borderCollapse:"collapse",borderSpacing:0,"& caption":{...l.typography.body2,padding:l.spacing(2),color:(l.vars||l).palette.text.secondary,textAlign:"left",captionSide:"bottom"},variants:[{props:({ownerState:a})=>a.stickyHeader,style:{borderCollapse:"separate"}}]}))),re="table",ge=p.forwardRef(function(a,n){const r=R({props:a,name:"MuiTable"}),{className:s,component:t=re,padding:i="normal",size:c="medium",stickyHeader:b=!1,...T}=r,f={...r,component:t,padding:i,size:c,stickyHeader:b},N=ye(f),I=p.useMemo(()=>({padding:i,size:c,stickyHeader:b}),[i,c,b]);return e.jsx(pe.Provider,{value:I,children:e.jsx(fe,{as:t,role:t===re?null:"table",ref:n,className:k(N.root,s),ownerState:f,...T})})}),G=p.createContext();function we(l){return v("MuiTableBody",l)}S("MuiTableBody",["root"]);const je=l=>{const{classes:a}=l;return B({root:["root"]},we,a)},Re=j("tbody",{name:"MuiTableBody",slot:"Root",overridesResolver:(l,a)=>a.root})({display:"table-row-group"}),ve={variant:"body"},se="tbody",Se=p.forwardRef(function(a,n){const r=R({props:a,name:"MuiTableBody"}),{className:s,component:t=se,...i}=r,c={...r,component:t},b=je(c);return e.jsx(G.Provider,{value:ve,children:e.jsx(Re,{className:k(b.root,s),as:t,ref:n,role:t===se?null:"rowgroup",ownerState:c,...i})})});function ke(l){return v("MuiTableCell",l)}const Be=S("MuiTableCell",["root","head","body","footer","sizeSmall","sizeMedium","paddingCheckbox","paddingNone","alignLeft","alignCenter","alignRight","alignJustify","stickyHeader"]),Ne=l=>{const{classes:a,variant:n,align:r,padding:s,size:t,stickyHeader:i}=l,c={root:["root",n,i&&"stickyHeader",r!=="inherit"&&`align${w(r)}`,s!=="normal"&&`padding${w(s)}`,`size${w(t)}`]};return B(c,ke,a)},He=j("td",{name:"MuiTableCell",slot:"Root",overridesResolver:(l,a)=>{const{ownerState:n}=l;return[a.root,a[n.variant],a[`size${w(n.size)}`],n.padding!=="normal"&&a[`padding${w(n.padding)}`],n.align!=="inherit"&&a[`align${w(n.align)}`],n.stickyHeader&&a.stickyHeader]}})(J(({theme:l})=>({...l.typography.body2,display:"table-cell",verticalAlign:"inherit",borderBottom:l.vars?`1px solid ${l.vars.palette.TableCell.border}`:`1px solid
    ${l.palette.mode==="light"?Te(K(l.palette.divider,1),.88):ue(K(l.palette.divider,1),.68)}`,textAlign:"left",padding:16,variants:[{props:{variant:"head"},style:{color:(l.vars||l).palette.text.primary,lineHeight:l.typography.pxToRem(24),fontWeight:l.typography.fontWeightMedium}},{props:{variant:"body"},style:{color:(l.vars||l).palette.text.primary}},{props:{variant:"footer"},style:{color:(l.vars||l).palette.text.secondary,lineHeight:l.typography.pxToRem(21),fontSize:l.typography.pxToRem(12)}},{props:{size:"small"},style:{padding:"6px 16px",[`&.${Be.paddingCheckbox}`]:{width:24,padding:"0 12px 0 16px","& > *":{padding:0}}}},{props:{padding:"checkbox"},style:{width:48,padding:"0 0 0 4px"}},{props:{padding:"none"},style:{padding:0}},{props:{align:"left"},style:{textAlign:"left"}},{props:{align:"center"},style:{textAlign:"center"}},{props:{align:"right"},style:{textAlign:"right",flexDirection:"row-reverse"}},{props:{align:"justify"},style:{textAlign:"justify"}},{props:({ownerState:a})=>a.stickyHeader,style:{position:"sticky",top:0,zIndex:2,backgroundColor:(l.vars||l).palette.background.default}}]}))),Me=p.forwardRef(function(a,n){const r=R({props:a,name:"MuiTableCell"}),{align:s="inherit",className:t,component:i,padding:c,scope:b,size:T,sortDirection:f,variant:N,...I}=r,x=p.useContext(pe),H=p.useContext(G),A=H&&H.variant==="head";let M;i?M=i:M=A?"th":"td";let P=b;M==="td"?P=void 0:!P&&A&&(P="col");const Q=N||H&&H.variant,X={...r,align:s,component:M,padding:c||(x&&x.padding?x.padding:"normal"),size:T||(x&&x.size?x.size:"medium"),sortDirection:f,stickyHeader:Q==="head"&&x&&x.stickyHeader,variant:Q},me=Ne(X);let le=null;return f&&(le=f==="asc"?"ascending":"descending"),e.jsx(He,{as:M,ref:n,className:k(me.root,t),"aria-sort":le,scope:P,ownerState:X,...I})});function $e(l){return v("MuiTableContainer",l)}S("MuiTableContainer",["root"]);const Pe=l=>{const{classes:a}=l;return B({root:["root"]},$e,a)},Ie=j("div",{name:"MuiTableContainer",slot:"Root",overridesResolver:(l,a)=>a.root})({width:"100%",overflowX:"auto"}),Ae=p.forwardRef(function(a,n){const r=R({props:a,name:"MuiTableContainer"}),{className:s,component:t="div",...i}=r,c={...r,component:t},b=Pe(c);return e.jsx(Ie,{ref:n,as:t,className:k(b.root,s),ownerState:c,...i})});function ze(l){return v("MuiTableFooter",l)}S("MuiTableFooter",["root"]);const qe=l=>{const{classes:a}=l;return B({root:["root"]},ze,a)},Ee=j("tfoot",{name:"MuiTableFooter",slot:"Root",overridesResolver:(l,a)=>a.root})({display:"table-footer-group"}),Le={variant:"footer"},ie="tfoot",De=p.forwardRef(function(a,n){const r=R({props:a,name:"MuiTableFooter"}),{className:s,component:t=ie,...i}=r,c={...r,component:t},b=qe(c);return e.jsx(G.Provider,{value:Le,children:e.jsx(Ee,{as:t,className:k(b.root,s),ref:n,role:t===ie?null:"rowgroup",ownerState:c,...i})})});function Oe(l){return v("MuiTableHead",l)}S("MuiTableHead",["root"]);const Fe=l=>{const{classes:a}=l;return B({root:["root"]},Oe,a)},Ue=j("thead",{name:"MuiTableHead",slot:"Root",overridesResolver:(l,a)=>a.root})({display:"table-header-group"}),We={variant:"head"},ce="thead",_e=p.forwardRef(function(a,n){const r=R({props:a,name:"MuiTableHead"}),{className:s,component:t=ce,...i}=r,c={...r,component:t},b=Fe(c);return e.jsx(G.Provider,{value:We,children:e.jsx(Ue,{as:t,className:k(b.root,s),ref:n,role:t===ce?null:"rowgroup",ownerState:c,...i})})});function Ve(l){return v("MuiTableRow",l)}const de=S("MuiTableRow",["root","selected","hover","head","footer"]),Je=l=>{const{classes:a,selected:n,hover:r,head:s,footer:t}=l;return B({root:["root",n&&"selected",r&&"hover",s&&"head",t&&"footer"]},Ve,a)},Ge=j("tr",{name:"MuiTableRow",slot:"Root",overridesResolver:(l,a)=>{const{ownerState:n}=l;return[a.root,n.head&&a.head,n.footer&&a.footer]}})(J(({theme:l})=>({color:"inherit",display:"table-row",verticalAlign:"middle",outline:0,[`&.${de.hover}:hover`]:{backgroundColor:(l.vars||l).palette.action.hover},[`&.${de.selected}`]:{backgroundColor:l.vars?`rgba(${l.vars.palette.primary.mainChannel} / ${l.vars.palette.action.selectedOpacity})`:K(l.palette.primary.main,l.palette.action.selectedOpacity),"&:hover":{backgroundColor:l.vars?`rgba(${l.vars.palette.primary.mainChannel} / calc(${l.vars.palette.action.selectedOpacity} + ${l.vars.palette.action.hoverOpacity}))`:K(l.palette.primary.main,l.palette.action.selectedOpacity+l.palette.action.hoverOpacity)}}}))),be="tr",Qe=p.forwardRef(function(a,n){const r=R({props:a,name:"MuiTableRow"}),{className:s,component:t=be,hover:i=!1,selected:c=!1,...b}=r,T=p.useContext(G),f={...r,component:t,hover:i,selected:c,head:T&&T.variant==="head",footer:T&&T.variant==="footer"},N=Je(f);return e.jsx(Ge,{as:t,ref:n,className:k(N.root,s),role:t===be?null:"row",ownerState:f,...b})}),Xe=he(e.jsx("path",{d:"M20 12l-1.41-1.41L13 16.17V4h-2v12.17l-5.58-5.59L4 12l8 8 8-8z"}),"ArrowDownward");function Ke(l){return v("MuiTableSortLabel",l)}const Y=S("MuiTableSortLabel",["root","active","icon","iconDirectionDesc","iconDirectionAsc","directionDesc","directionAsc"]),Ye=l=>{const{classes:a,direction:n,active:r}=l,s={root:["root",r&&"active",`direction${w(n)}`],icon:["icon",`iconDirection${w(n)}`]};return B(s,Ke,a)},Ze=j(Ce,{name:"MuiTableSortLabel",slot:"Root",overridesResolver:(l,a)=>{const{ownerState:n}=l;return[a.root,n.active&&a.active]}})(J(({theme:l})=>({cursor:"pointer",display:"inline-flex",justifyContent:"flex-start",flexDirection:"inherit",alignItems:"center","&:focus":{color:(l.vars||l).palette.text.secondary},"&:hover":{color:(l.vars||l).palette.text.secondary,[`& .${Y.icon}`]:{opacity:.5}},[`&.${Y.active}`]:{color:(l.vars||l).palette.text.primary,[`& .${Y.icon}`]:{opacity:1,color:(l.vars||l).palette.text.secondary}}}))),el=j("span",{name:"MuiTableSortLabel",slot:"Icon",overridesResolver:(l,a)=>{const{ownerState:n}=l;return[a.icon,a[`iconDirection${w(n.direction)}`]]}})(J(({theme:l})=>({fontSize:18,marginRight:4,marginLeft:4,opacity:0,transition:l.transitions.create(["opacity","transform"],{duration:l.transitions.duration.shorter}),userSelect:"none",variants:[{props:{direction:"desc"},style:{transform:"rotate(0deg)"}},{props:{direction:"asc"},style:{transform:"rotate(180deg)"}}]}))),Z=p.forwardRef(function(a,n){const r=R({props:a,name:"MuiTableSortLabel"}),{active:s=!1,children:t,className:i,direction:c="asc",hideSortIcon:b=!1,IconComponent:T=Xe,slots:f={},slotProps:N={},...I}=r,x={...r,active:s,direction:c,hideSortIcon:b,IconComponent:T},H=Ye(x),A={slots:f,slotProps:N},[M,P]=ne("root",{elementType:Ze,externalForwardedProps:A,ownerState:x,className:k(H.root,i),ref:n}),[Q,X]=ne("icon",{elementType:el,externalForwardedProps:A,ownerState:x,className:H.icon});return e.jsxs(M,{disableRipple:!0,component:"span",...P,...I,children:[t,b&&!s?null:e.jsx(Q,{as:T,...X})]})}),m=$.forwardRef(({children:l,size:a="medium",stickyHeader:n=!1,padding:r="normal",...s},t)=>e.jsx(ge,{ref:t,size:a,stickyHeader:n,padding:r,...s,children:l}));m.displayName="Table";const y=$.forwardRef(({children:l,...a},n)=>e.jsx(Ae,{ref:n,...a,children:l}));y.displayName="TableContainer";const h=$.forwardRef(({children:l,...a},n)=>e.jsx(_e,{ref:n,...a,children:l}));h.displayName="TableHead";const C=$.forwardRef(({children:l,...a},n)=>e.jsx(Se,{ref:n,...a,children:l}));C.displayName="TableBody";const ee=$.forwardRef(({children:l,...a},n)=>e.jsx(De,{ref:n,...a,children:l}));ee.displayName="TableFooter";const d=$.forwardRef(({children:l,selected:a=!1,hover:n=!1,...r},s)=>e.jsx(Qe,{ref:s,selected:a,hover:n,...r,children:l}));d.displayName="TableRow";const o=$.forwardRef(({children:l,align:a="left",padding:n="normal",size:r="medium",variant:s,colSpan:t,rowSpan:i,sortDirection:c,...b},T)=>e.jsx(Me,{ref:T,align:a,padding:n,size:r,variant:s,colSpan:t,rowSpan:i,sortDirection:c,...b,children:l}));o.displayName="TableCell";m.__docgenInfo={description:"Table component for displaying tabular data",methods:[],displayName:"Table",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"The content of the table (typically TableHead, TableBody, TableFooter)"},size:{required:!1,tsType:{name:"union",raw:"'small' | 'medium'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'medium'"}]},description:`The size of the table
...
}`,...V.parameters?.docs?.source},description:{story:"Without TableContainer (no Paper wrapper)",...V.parameters?.docs?.description}}};const jl=["Default","Dense","StickyHeader","WithHover","Selectable","Sortable","WithActions","WithFooter","WithSpans","WithAlignment","WithoutContainer"];export{z as Default,q as Dense,D as Selectable,O as Sortable,E as StickyHeader,F as WithActions,_ as WithAlignment,U as WithFooter,L as WithHover,W as WithSpans,V as WithoutContainer,jl as __namedExportsOrder,wl as default};
