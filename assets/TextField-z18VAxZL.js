...
@default false`,defaultValue:{value:"false",computed:!1}},label:{required:!1,tsType:{name:"string"},description:"The label content"},placeholder:{required:!1,tsType:{name:"string"},description:"The short hint displayed in the input before the user enters a value"},helperText:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"The helper text content"},defaultValue:{required:!1,tsType:{name:"unknown"},description:"The default value. Use when the component is not controlled"},value:{required:!1,tsType:{name:"unknown"},description:"The value of the input element, required for a controlled component"},type:{required:!1,tsType:{name:"string"},description:`Type of the input element
