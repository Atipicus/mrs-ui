...
const meta: Meta<typeof Menu> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Menus display a list of choices on temporary surfaces. They appear when users interact with a button, action, or other control.',
      },
    },
  },
  tags: ['autodocs'],
  argTypes: {
    ...
    transformOrigin: {
      control: 'object',
      description: 'The position of the Menu relative to the anchor element',
    },
    autoFocus: {
      control: 'boolean',
      description: 'If true, the Menu will automatically select the first item',
    },
    variant: {
      control: 'select',
...
/**
 * Icon button menu (more common pattern)
 */
