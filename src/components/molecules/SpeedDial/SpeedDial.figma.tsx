  ...
  'https://www.figma.com/design/pWR8HIewAt87ZioeOSMoWM/MRS---Material-UI?node-id=11137-155769',
  {
    ...
    example: (props) => (
      <SpeedDial
        ...
        hidden={props.hidden}
      >
        <SpeedDialAction icon={<FileCopyIcon />} tooltipTitle="Copy" onClick={() => {}} />
        <SpeedDialAction icon={<SaveIcon />} tooltipTitle="Save" onClick={() => {}} />
        <SpeedDialAction icon={<PrintIcon />} tooltipTitle="Print" onClick={() => {}} />
      </SpeedDial>
    ),
  }
);
