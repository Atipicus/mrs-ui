...
import type { TimelineProps as MuiTimelineProps } from '@mui/lab/Timeline';
import type { TimelineItemProps as MuiTimelineItemProps } from '@mui/lab/TimelineItem';
import type { TimelineSeparatorProps as MuiTimelineSeparatorProps } from '@mui/lab/TimelineSeparator';
import type { TimelineDotProps as MuiTimelineDotProps } from '@mui/lab/TimelineDot';
import type { TimelineConnectorProps as MuiTimelineConnectorProps } from '@mui/lab/TimelineConnector';
import type { TimelineContentProps as MuiTimelineContentProps } from '@mui/lab/TimelineContent';
import type { TimelineOppositeContentProps as MuiTimelineOppositeContentProps } from '@mui/lab/TimelineOppositeContent';
